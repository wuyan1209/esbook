...
!function (t) {
    t.en = Object.assign(t.en || {}, {
        ...
        ao: "Insert table",
        ap: "Header column",
        aq: "Insert column left",
        ar: "Insert column right",
        as: "Delete column",
        at: "Column",
        au: "Header row",
        av: "Insert row below",
        ...
        bb: "Merge cell down",
        bc: "Merge cell left",
        bd: "Split cell vertically",
        be: "Split cell horizontally",
        bf: "Merge cells",
        bg: "media widget",
        bh: "Link",
        bi: "Black",
        ...
        bv: "Blue",
        bw: "Purple",
        bx: "Upload in progress",
        by: "Open in a new tab",
        bz: "Downloadable",
        ca: "Unlink",
        cb: "Edit link",
        cc: "Open link in new tab",
        cd: "This link has no URL",
        ce: "Save",
        cf: "Cancel",
        cg: "Link URL",
        ch: "Undo",
        ci: "Redo",
        cj: "Rich Text Editor, %0",
        ck: "%0 of %1",
        cl: "Previous",
        cm: "Next",
        cn: "Paragraph",
        ...
        cs: "Heading 5",
        ct: "Heading 6",
        cu: "Change image text alternative",
        cv: "Could not obtain resized image URL.",
        cw: "Selecting resized image failed",
        cx: "Could not insert image at the current position.",
        cy: "Inserting image failed",
        cz: "Insert media",
    ...
    return function (t) {
        ...
        function d(t, e) {
            for (var n = 0; n < t.length; n++) {
                ...
                if (r) {
                    ...
                    for (; s < o.parts.length; s++) r.parts.push(p(o.parts[s], e))
                } else {
                    var a = [];
                    for (s = 0; s < o.parts.length; s++) a.push(p(o.parts[s], e));
        ...
        "use strict";
        (function (t) {
            var i = n(4), o = n(21), r = "object" == typeof exports && exports && !exports.nodeType && exports,
        ...
        var re = function (t, e) {
            var n = Wt(t), i = !n && qt(t), o = !n && !i && Object(Yt.a)(t), r = !n && !i && !o && ie(t),
                s = n || i || o || r, a = s ? jt(t.length, String) : [], c = a.length;
        ...
        var Ne = function (t) {
                return Ee(t, be, Me)
            }, Oe = rt(i.a, "DataView"), Re = rt(i.a, "Promise"), De = rt(i.a, "Set"), Le = rt(i.a, "WeakMap"), Ve = K(Oe),
            je = K(st), ze = K(Re), Be = K(De), Fe = K(Le), Ue = g;
        ...
        var Tn = function (t) {
            return w(t) && He(t) == Cn
        }, Pn = ee.a && ee.a.isMap, Mn = Pn ? te(Pn) : Tn, Sn = "[object Set]";
        var En = function (t) {
                return w(t) && He(t) == Sn
            }, In = ee.a && ee.a.isSet, Nn = In ? te(In) : En, On = 1, Rn = 2, Dn = 4, Ln = "[object Arguments]",
            Vn = "[object Function]", jn = "[object GeneratorFunction]", zn = "[object Object]", Bn = {};
        ...
        var Fn = function t(e, n, i, o, r, s) {
            ...
            var g = d ? l ? Ne : Ie : l ? keysIn : he, p = u ? void 0 : g(e);
        ...
        const Vi = Symbol("observableProperties"), ji = Symbol("boundObservables"), zi = Symbol("boundProperties"),
            Bi = {
                set(t, e) {
        ...
        function Ui(t) {
            Vi in t || (Object.defineProperty(t, Vi, {value: new Map}), Object.defineProperty(t, ji, {value: new Map}), Object.defineProperty(t, zi, {value: new Map}))
        }
        ...
        }, Vo = t => t.createTextNode(" "), jo = 7;
        let zo = "";
        for (let t = 0; t < jo; t++) zo += "​";
            ...
            * viewChildrenToDom(t, e, n = {}) {
            ...
            viewPositionToDom(t) {
                ...
                if (e.is("text")) {
                    ...
                    if (!n) return null;
                    let i = t.offset;
                    return Bo(n) && (i += jo), {parent: n, offset: i}
                }
                {
                    let n, i, o;
                    if (0 === t.offset) {
                    ...
                    if (Do(o) && Bo(o)) return {parent: o, offset: jo};
            ...
            * domChildrenToView(t, e = {}) {
            ...
            domPositionToView(t, e) {
                ...
                if (Do(t)) {
                    ...
                    let i = e;
                    return n ? (Bo(t) && (i = (i -= jo) < 0 ? 0 : i), new Zi(n, i)) : null
                }
                if (0 === e) {
        ...
        var Ar = function (t) {
            ...
            }, Cr = 1, Tr = 2, Pr = "[object Boolean]", Mr = "[object Date]", Sr = "[object Error]", Er = "[object Map]",
            Ir = "[object Number]", Nr = "[object RegExp]", Or = "[object Set]", Rr = "[object String]",
            Dr = "[object Symbol]", Lr = "[object ArrayBuffer]", Vr = "[object DataView]",
        ...
        class Cs {
            ...
            isEqual(t) {
                for (const e of As) if (this[e] !== t[e]) return !1;
                return !0
            }
            ...
            static getDomRangeRects(t) {
                ...
                if (n.length) for (const t of n) e.push(new Cs(t)); else {
        ...
        function Ms({target: t, viewportOffset: e = 0}) {
            const n = Ds(t);
            let i = n, o = null;
            for (; i;) {
                let r;
                Es(r = Ls(i == n ? t : o), () => Vs(t, i));
                const s = Vs(t, i);
        ...
        function Ss(t, e, n) {
            const i = e.clone().moveBy(0, n), o = e.clone().moveBy(0, -n), r = new Cs(t).excludeScrollbarsAndBorders();
        ...
        function Es(t, e) {
            const n = Ds(t);
            let i, o;
            for (; t != n.document.body;) o = e(), (i = new Cs(t).excludeScrollbarsAndBorders()).contains(o) || (Ns(o, i) ? t.scrollTop -= i.top - o.top : Is(o, i) && (t.scrollTop += o.bottom - i.bottom), Os(o, i) ? t.scrollLeft -= i.left - o.left : Rs(o, i) && (t.scrollLeft += o.right - i.right)), t = t.parentNode
        }
        ...
        Object.assign({}, {
            scrollViewportToShowTarget: Ms, scrollAncestorsToShowTarget: function (t) {
                Es(Ls(t), () => new Cs(t))
            }
        });
        ...
        class js {
            ...
            scrollToTheSelection() {
                ...
                t && Ms({target: this.domConverter.viewRangeToDom(t), viewportOffset: 20})
            }
        ...
        class Hs {
            ...
            _insertNodes(t, e) {
                for (const t of e) if (!(t instanceof Bs)) throw new Gn.b("model-nodelist-insertNodes-not-node: Trying to insert an object which is not a Node instance.", this);
        ...
        class qs extends Bs {
            constructor(t, e, n) {
                super(e), this.name = t, this._children = new Hs, n && this._insertChild(0, n)
            }
            ...
            _insertChild(t, e) {
                const n = function (t) {
                    ...
                    pi(t) || (t = [t]);
                    return Array.from(t).map(t => "string" == typeof t ? new Fs(t) : t instanceof Us ? new Fs(t.data, t.getAttributes()) : t)
                }(e);
            ...
            static fromJSON(t) {
                ...
                if (t.children) {
                    e = [];
                    for (const n of t.children) n.name ? e.push(qs.fromJSON(n)) : e.push(Fs.fromJSON(n))
                }
        ...
        class Gs {
            constructor(t, e, n = "toNone") {
                ...
                if (!(e instanceof Array) || 0 === e.length) throw new Gn.b("model-position-path-incorrect: Position path must be an array with at least one item.", t, {path: e});
            ...
            _getCombined(t, e) {
                const n = t.path.length - 1, i = Gs._createAt(e);
        ...
        class Qs {
            ...
            * [Symbol.iterator]() {
            ...
            getMinimalFlatRanges() {
                const t = [], e = this.start.getCommonPath(this.end).length, n = Gs._createAt(this.start);
                let i = n.parent;
            ...
            * getPositions(t = {}) {
            ...
            _getTransformedByMove(t, e, n, i = !1) {
                ...
                const o = Qs._createFromPositionAndShift(t, n), r = e._getTransformedByDeletion(t, n);
            ...
            static _createFromRanges(t) {
                ...
                if (n > 0) for (let e = n - 1; t[e].end.isEqual(i.start); e++) i.start = Gs._createAt(t[e].start);
                for (let e = n + 1; e < t.length && t[e].start.isEqual(i.end); e++) i.end = Gs._createAt(t[e].end);
                return i
            }
        ...
        class Xs {
            ...
            convertInsert(t, e) {
                ...
                for (const e of t) {
                    const t = e.item,
                        n = {item: t, range: Qs._createFromPositionAndShift(e.previousPosition, e.length)};
            ...
            convertSelection(t, e, n) {
                ...
                if (this.conversionApi.writer = n, this.conversionApi.consumable = this._createSelectionConsumable(t, i), this.fire("selection", {selection: t}, this.conversionApi), t.isCollapsed) {
                    for (const e of i) {
                        const n = e.getRange();
                        if (!ta(t.getFirstPosition(), e, this.conversionApi.mapper)) continue;
        ...
        class ea {
            ...
            * getRanges() {
            ...
            setTo(t, e, n) {
                if (null === t) this._setRanges([]); else if (t instanceof ea) this._setRanges(t.getRanges(), t.isBackward); else if (t && "function" == typeof t.getRanges) this._setRanges(t.getRanges(), t.isBackward); else if (t instanceof Qs) this._setRanges([t], !!e && !!e.backward); else if (t instanceof Gs) this._setRanges([new Qs(t)]); else if (t instanceof Bs) {
                    const i = !!n && !!n.backward;
                    let o;
                    if ("in" == e) o = Qs._createIn(t); else if ("on" == e) o = Qs._createOn(t); else {
            ...
            _setRanges(t, e = !1) {
                const n = (t = Array.from(t)).some(e => {
                    if (!(e instanceof Qs)) throw new Gn.b("model-selection-set-ranges-not-range: Selection range set to an object that is not an instance of model.Range.", [this, t]);
            ...
            setFocus(t, e) {
                ...
                if ("same" == n.compareWith(this.focus)) return;
                const i = this.anchor;
                this._ranges.length && this._popRange(), "before" == n.compareWith(i) ? (this._pushRange(new Qs(n, i)), this._lastRangeBackward = !0) : (this._pushRange(new Qs(i, n)), this._lastRangeBackward = !1), this.fire("change:range", {directChange: !0})
            }
            ...
            * getSelectedBlocks() {
                ...
                for (const e of this.getRanges()) {
                    ...
                    n && (yield n);
                    for (const n of e.getWalker()) "elementEnd" == n.type && na(n.item, t) && (yield n.item);
                    const i = ia(e.end, t);
            ...
            * getTopMostBlocks() {
            ...
            containsEntireContent(t = this.anchor.root) {
                const e = Gs._createAt(t, 0), n = Gs._createAt(t, "end");
        ...
        function ia(t, e) {
            ...
            let o = !1;
            const r = i.find(t => !o && (!(o = n.isLimit(t)) && na(t, e)));
                ...
                super(t, e), function () {
                    this.listenTo(this.root.document.model, "applyOperation", (t, e) => {
                        ...
                        n.isDocumentOperation && function (t) {
                            const e = this.getTransformedByOperation(t), n = Qs._createFromRanges(e),
        ...
        class ca extends ea {
                    ...
                    !function (t, e) {
                        ...
                        for (const i of n.getChanges()) {
                            ...
                            o && t.enqueueChange(e, t => {
                                const e = Array.from(n.getAttributeKeys()).filter(t => t.startsWith(sa));
            ...
            * getRanges() {
            ...
            _updateAttributes(t) {
                const e = zs(this._getSurroundingAttributes()), n = zs(this.getAttributes());
            ...
            * _getStoredAttributes() {
                ...
                if (this.isCollapsed && t.isEmpty) for (const e of t.getAttributeKeys()) if (e.startsWith(sa)) {
            ...
            _getSurroundingAttributes() {
                ...
                if (this.isCollapsed) {
                    ...
                    if (this.isGravityOverridden || (n = la(e)), n || (n = la(i)), !this.isGravityOverridden && !n) {
                        let t = e;
                        for (; t && !n;) n = la(t = t.previousSibling)
                    }
                    if (!n) {
                        let t = i;
                        for (; t && !n;) n = la(t = t.nextSibling)
                    }
        ...
        class ma extends da {
            elementToElement(t) {
                return this.add(function (t) {
                    return (t = fa(t)).view = pa(t.view, "container"), e => {
            ...
            attributeToElement(t) {
                return this.add(function (t) {
                    let e = "attribute:" + ((t = fa(t)).model.key ? t.model.key : t.model);
            ...
            attributeToAttribute(t) {
                return this.add(function (t) {
                    let e = "attribute:" + ((t = fa(t)).model.key ? t.model.key : t.model);
                    t.model.name && (e += ":" + t.model.name);
                    if (t.model.values) for (const e of t.model.values) t.view[e] = wa(t.view[e]); else t.view = wa(t.view);
                    const n = ba(t);
                    return i => {
                        i.on(e, function (t) {
                            return (e, n, i) => {
            ...
            markerToElement(t) {
                return this.add(function (t) {
                    return (t = fa(t)).view = pa(t.view, "ui"), e => {
                        ...
                        e.on("addMarker:" + t.model, function (t) {
                            ...
                            return (e, n, i) => {
                                ...
                                if (r && r.getCustomProperty("addHighlight")) {
                                    ...
                                    for (const t of Qs._createIn(n.item)) i.consumable.consume(t.item, e.name);
        ...
        class _a extends da {
            ...
            elementToAttribute(t) {
                return this.add(function (t) {
                    xa(t = fa(t));
                    const e = Aa(t, !1), n = ya(t), i = n ? "element:" + n : "element";
                    return n => {
        ...
        function va(t) {
            ...
            }(t = fa(t)), n = ya(t), i = n ? "element:" + n : "element";
            return n => {
        ...
        class Ca {
            constructor(t) {
                this.model = t, this.view = new js, this.mapper = new Ks, this.downcastDispatcher = new Xs({mapper: this.mapper});
                ...
                this.listenTo(this.model, "_beforeChanges", () => {
                    ...
                    return (n, i) => {
                        const o = i.newSelection, r = new ea, s = [];
        ...
        class Na {
            constructor() {
                this._sourceDefinitions = {}, this._attributeProperties = {}, this.decorate("checkChild"), this.decorate("checkAttribute"), this.on("checkAttribute", (t, e) => {
                    ...
                    e[0] = new Oa(e[0]), e[1] = this.getDefinition(e[1])
                }, {priority: "highest"})
            }
            ...
            checkMerge(t, e = null) {
                if (t instanceof Gs) {
                    const e = t.nodeBefore, n = t.nodeAfter;
                    if (!(e instanceof qs)) throw new Gn.b("schema-check-merge-no-element-before: The node before the merge position must be an element.", this);
                    if (!(n instanceof qs)) throw new Gn.b("schema-check-merge-no-element-after: The node after the merge position must be an element.", this);
            ...
            * getValidRanges(t, e) {
            ...
            _compile() {
                ...
                for (const e of n) Va(t, e), ja(t, e);
                for (const e of n) za(t, e), Ba(t, e);
            ...
            * _getValidRangesForRange(t, e) {
                ...
                for (const o of t.getItems({shallow: !0})) o.is("element") && (yield* this._getValidRangesForRange(Qs._createIn(o), e)), this.checkAttribute(o, e) || (n.isEqual(i) || (yield new Qs(n, i)), n = Gs._createAfter(o)), i = Gs._createAfter(o);
        ...
        class Oa {
            constructor(t) {
                ...
                "string" == typeof t ? t = [t] : Array.isArray(t) || (t = t.getAncestors({includeSelf: !0})), t[0] && "string" != typeof t[0] && t[0].is("documentFragment") && t.shift(), this._items = t.map(Ha)
            }
            ...
            convert(t, e, n = ["$root"]) {
                ...
                if (i) {
                    ...
                    o.markers = function (t, e) {
                        const n = new Set, i = new Map, o = Qs._createIn(t).getItems();
        ...
        class Wa {
            constructor(t, e) {
                this.model = t, this.processor = e, this.mapper = new Ks, this.downcastDispatcher = new Xs({mapper: this.mapper}), this.downcastDispatcher.on("insert:$text", (t, e, n) => {
                    if (!n.consumable.consume(e.item, "insert")) return;
                    const i = n.writer, o = n.mapper.toViewPosition(e.range.start), r = i.createText(e.item.data);
                    i.insert(o, r)
                }, {priority: "lowest"}), this.upcastDispatcher = new qa({schema: t.schema}), this.upcastDispatcher.on("text", (t, e, n) => {
            ...
            toView(t) {
                ...
                const e = Qs._createIn(t), n = new Ao, i = new Co(new ro);
        ...
        class Ya {
            ...
            elementToElement(t) {
                ...
                for (const {model: e, view: n} of $a(t)) this.for("upcast").elementToElement({
                    model: e,
                    view: n,
            ...
            attributeToElement(t) {
                ...
                for (const {model: e, view: n} of $a(t)) this.for("upcast").elementToAttribute({
                    view: n,
                    model: e,
                    converterPriority: t.converterPriority
                })
            ...
            attributeToAttribute(t) {
                ...
                for (const {model: e, view: n} of $a(t)) this.for("upcast").attributeToAttribute({view: n, model: e})
            }
        ...
        class Ja {
            ...
            static fromJSON(t) {
                const e = [];
                for (const n of t) n.name ? e.push(qs.fromJSON(n)) : e.push(Fs.fromJSON(n));
                return new Ja(e)
            }
        ...
        function Za(t, e) {
            const n = (e = ec(e)).reduce((t, e) => t + e.offsetSize, 0), i = t.parent;
            ic(t);
            const o = t.index;
        ...
        function ec(t) {
            ...
            for (let n = 0; n < t.length; n++) if ("string" == typeof t[n]) e.push(new Fs(t[n])); else if (t[n] instanceof Us) e.push(new Fs(t[n].data, t[n].getAttributes())); else if (t[n] instanceof Ja || t[n] instanceof Hs) for (const i of t[n]) e.push(i); else t[n] instanceof Bs && e.push(t[n]);
        ...
        function ic(t) {
            ...
            if (e) {
                ...
                const r = new Fs(e.data.substr(0, i), e.getAttributes()),
        ...
        class sc extends Ka {
            ...
            _validate() {
                ...
                for (const t of this.range.getItems({shallow: !0})) {
                    if (null !== this.oldValue && !rc(t.getAttribute(this.key), this.oldValue)) throw new Gn.b("attribute-operation-wrong-old-value: Changed node has different attribute value than operation's old attribute value.", this, {
                        item: t,
                        key: this.key,
                        value: this.oldValue
                    });
        ...
        class cc extends Ka {
            ...
            static fromJSON(t, e) {
                const n = Gs.fromJSON(t.sourcePosition, e), i = Gs.fromJSON(t.targetPosition, e);
        ...
        class lc extends Ka {
            constructor(t, e, n) {
                super(n), this.position = t.clone(), this.position.stickiness = "toNone", this.nodes = new Hs(ec(e)), this.shouldReceiveAttributes = !1
            }
            ...
            _execute() {
                const t = this.nodes;
                this.nodes = new Hs([...t].map(t => t._clone(!0))), Za(this.position, t)
            }
            ...
            static fromJSON(t, e) {
                const n = [];
                for (const e of t.nodes) e.name ? n.push(qs.fromJSON(e)) : n.push(Fs.fromJSON(e));
                const i = new lc(Gs.fromJSON(t.position, e), n, t.baseVersion);
        ...
        class mc extends Ka {
            ...
            getReversed() {
                const t = this.splitPosition.root.document.graveyard, e = new Gs(t, [0]);
            ...
            static fromJSON(t, e) {
                const n = Gs.fromJSON(t.splitPosition, e), i = Gs.fromJSON(t.insertionPosition, e),
        ...
        class pc {
            ...
            insert(t, e, n = 0) {
                ...
                const o = i.root.document ? i.root.document.version : null, r = new lc(i, t, o);
                if (t instanceof Fs && (r.shouldReceiveAttributes = !0), this.batch.addOperation(r), this.model.applyOperation(r), t instanceof Ja) for (const [e, n] of t.markers) {
                    const t = Gs._createAt(n.root, 0), o = {
                        range: new Qs(n.start._getCombined(t, i), n.end._getCombined(t, i)),
                        usingOperation: !0,
                        affectsData: !0
                    };
            ...
            setAttribute(t, e, n) {
                if (this._assertWriterUsedCorrectly(), n instanceof Qs) {
                    ...
                    for (const n of i) bc(this, t, e, n)
                } else wc(this, t, e, n)
            }

            setAttributes(t, e) {
                for (const [n, i] of zs(t)) this.setAttribute(n, i, e)
            }

            removeAttribute(t, e) {
                if (this._assertWriterUsedCorrectly(), e instanceof Qs) {
                    const n = e.getMinimalFlatRanges();
                    for (const e of n) bc(this, t, null, e)
            ...
            remove(t) {
                this._assertWriterUsedCorrectly();
                const e = (t instanceof Qs ? t : Qs._createOn(t)).getMinimalFlatRanges().reverse();
            ...
            _merge(t) {
                const e = Gs._createAt(t.nodeBefore, "end"), n = Gs._createAt(t.nodeAfter, 0),
                    i = t.root.document.graveyard, o = new Gs(i, [0]), r = t.root.document.version,
            ...
            wrap(t, e) {
                ...
                const i = new Qs(t.start.getShiftedBy(1), t.end.getShiftedBy(1));
            ...
            setSelectionAttribute(t, e) {
                if (this._assertWriterUsedCorrectly(), "string" == typeof t) this._setSelectionAttribute(t, e); else for (const [e, n] of zs(t)) this._setSelectionAttribute(e, n)
            }
        ...
        function bc(t, e, n, i) {
            ...
            function d() {
                const i = new Qs(l, s), c = i.root.document ? r.version : null, d = new sc(i, e, a, n, c);
        ...
        function kc(t, e, n, i, o) {
            const r = t.model, s = r.document, a = new dc(e, n, i, r.markers, o, s.version);
        ...
        class yc {
            ...
            getChanges(t = {includeChangesInGraveyard: !1}) {
                ...
                for (const t of this._changesInElement.keys()) {
                    const n = this._changesInElement.get(t).sort((t, e) => t.offset === e.offset ? t.type != e.type ? "remove" == t.type ? -1 : 1 : 0 : t.offset < e.offset ? -1 : 1),
                        i = this._elementSnapshots.get(t), o = xc(t.getChildren()), r = Ac(i.length, n);
                    let s = 0, a = 0;
                    for (const n of r) if ("i" === n) e.push(this._getInsertDiff(t, s, o[s].name)), s++; else if ("r" === n) e.push(this._getRemoveDiff(t, s, i[a].name)), a++; else if ("a" === n) {
                        ...
                        let c;
                        if ("$text" == o[s].name) c = new Qs(Gs._createAt(t, s), Gs._createAt(t, s + 1)); else {
            ...
            _removeAllNestedChanges(t, e, n) {
                const i = new Qs(Gs._createAt(t, e), Gs._createAt(t, e + n));
        ...
        class Ec {
            constructor(t) {
                this.model = t, this.version = 0, this.history = new Tc(this), this.selection = new aa(this), this.roots = new oo({idProperty: "rootName"}), this.differ = new yc(t.markers), this._postFixers = new Set, this._hasSelectionChangedFromTheLastChangeBlock = !1, this.createRoot("$root", Sc), this.listenTo(t, "applyOperation", (t, e) => {
                    const n = e[0];
            ...
            getRootNames() {
                return Array.from(this.roots, t => t.rootName).filter(t => t != Sc)
            }
        ...
        class Nc {
            ...
            _set(t, e, n = !1, i = !1) {
                const o = t instanceof Oc ? t.name : t, r = this._markers.get(o);
                if (r) {
                    const t = r.getRange();
                    let s = !1;
                ...
                const s = ra.fromRange(e), a = new Oc(o, s, n, i);
                return this._markers.set(o, a), this.fire("update:" + o, a, null, e), a
            }

            _remove(t) {
                const e = t instanceof Oc ? t.name : t, n = this._markers.get(e);
        ...
        class Dc {
            ...
            _mergeSiblingsOf(t, e) {
                ...
                const n = this._canMergeLeft(t, e), i = this._canMergeRight(t, e), o = Rc._createBefore(t);
                o.stickiness = "toNext";
        ...
        function Lc(t, e, n = {}) {
            ...
            t.change(t => {
                ...
                const r = i.start, s = Rc.fromPosition(i.end, "toNext");
                if (i.start.isTouching(i.end) || t.remove(i), n.leaveUnmerged || (!function t(e, n, i) {
                    ...
                    n.doNotAutoparagraph && i ? jc(t, e, i) : Vc(t, r, e)
                }
                s.detach()
            })
        }
        ...
        function Bc(t, e, n = {}) {
            const i = t.schema, o = "backward" != n.direction, r = n.unit ? n.unit : "character", s = e.focus,
                a = new Ws({
                    boundaries: function (t, e) {
                        const n = t.root, i = Gs._createAt(n, e ? "end" : 0);
            ...
            for (; l = a.next();) {
                ...
                if (n) return void (e instanceof aa ? t.change(t => {
        ...
        function Fc(t, e) {
            if ("text" == e.type) return "word" === t.unit ? function (t, e) {
                ...
                if (n) {
                    ...
                    for (; !Uc(n.data, i, e) && !Hc(n, i, e);) {
                        ...
                        if (o && o.is("text")) {
                            ...
                            zc.includes(i) || (t.next(), n = t.position.textNode)
                        }
                ...
                if (n) {
                    ...
                    for (; Pc(i, o) || "character" == e && Mc(i, o);) t.next(), o = t.position.offset - n.startOffset
                }
                return t.position
            ...
            return t.isCollapsed ? function (t, e) {
                ...
                if (c || l) {
                    const t = n.nodeAfter && i.nodeBefore && n.nodeAfter.parent === i.nodeBefore.parent,
                        o = c && (!t || !Gc(n.nodeAfter, e)), r = l && (!t || !Gc(i.nodeBefore, e));
                    let d = n, u = i;
        ...
        class Qc {
            constructor() {
                this.markers = new Nc, this.document = new Ec(this), this.schema = new Na, this._pendingChanges = [], this._currentWriter = null, ["insertContent", "deleteContent", "modifySelection", "getSelectedContent", "applyOperation"].forEach(t => this.decorate(t)), this.on("applyOperation", (t, e) => {
                    e[0]._validate()
            ...
            insertContent(t, e, n) {
                return function (t, e, n, i) {
                    return t.change(o => {
                        let r;
                        const s = (r = n ? n instanceof ea || n instanceof aa ? n : o.createSelection(n, i) : t.document.selection).getFirstPosition();
                        r.isCollapsed || t.deleteContent(r, {doNotAutoparagraph: !0});
                        const a = new Dc(t, o, s);
                        let c;
            ...
            hasContent(t, e) {
                const n = t instanceof qs ? Qs._createIn(t) : t;
        ...
        class el {
            constructor() {
                this._domParser = new DOMParser, this._domConverter = new rr({blockFiller: Vo}), this._htmlWriter = new tl
            }
        ...
        class rl {
            constructor(t) {
                this.editor = t, this.componentFactory = new nl(t), this.focusTracker = new ol, this._editableElementsMap = new Map, this.listenTo(t.editing.view.document, "layoutChanged", () => this.update())
            }
            ...
            get _editableElements() {
                return bs.a.warn("editor-ui-deprecated-editable-elements: The EditorUI#_editableElements property has been deprecated and will be removed in the near future.", {editorUI: this}), this._editableElementsMap
            }
        }
        ...
        class ul extends rl {
            ...
            init() {
                const t = this.editor, e = this.view, n = t.editing.view, i = e.editable, o = n.document.getRoot();
        ...
        class ml {
            ...
            * getViews() {
                yield* function* t(e) {
                    if (e.children) for (const n of e.children) Ml(n) ? yield n : Sl(n) && (yield* t(n))
                }(this)
            }
            ...
            static bind(t, e) {
                return {
                    to: (n, i) => new pl({
                        ...
                        emitter: e,
                        callback: i
                    }), if: (n, i, o) => new bl({observable: t, emitter: e, attribute: n, valueIfTrue: i, callback: o})
                }
            }
            ...
            _renderAttributes(t) {
                ...
                for (e in this.attributes) if (i = r.getAttribute(e), n = this.attributes[e], s && (s.attributes[e] = i), o = B(n[0]) && n[0].ns ? n[0].ns : null, wl(n)) {
                    const a = o ? n[0].value : n;
                    s && Il(e) && a.unshift(i), this._bindToObservable({schema: a, updater: _l(r, e, o), data: t})
            ...
            _renderStyleAttribute(t, e) {
                ...
                for (const i in t) {
                    const o = t[i];
                    wl(o) ? this._bindToObservable({schema: [o], updater: vl(n, i), data: e}) : n.style[i] = o
                }
            }
            ...
            _renderElementChildren(t) {
                ...
                let o = 0;
                for (const r of this.children) if (El(r)) {
                    if (!i) {
                        r.setParent(e);
                        for (const t of r) n.appendChild(t.element)
                    }
                } else if (Ml(r)) i || (r.isRendered || r.render(), n.appendChild(r.element)); else if (Zo(r)) n.appendChild(r); else if (i) {
        ...
        function xl(t) {
            if ("string" == typeof t ? t = function (t) {
                ...
                const e = [];
                if (t.children) if (El(t.children)) e.push(t.children); else for (const n of t.children) Sl(n) || Ml(n) || Zo(n) ? e.push(n) : e.push(new ml(n));
                t.children = e
            }
            return t
        }
        ...
        class Dl extends Rl {
            ...
            render() {
                ...
                t.change(n => {
                    ...
                    n.setAttribute("aria-label", e("cj", [this.name]), i)
                })
            }
        }
        ...
        class zl extends Nl {
            constructor(t) {
                ...
                this.items = this.createCollection(), this.focusTracker = new ol, this.keystrokes = new Kc, this.set("isVertical", !1), this.set("class"), this._focusCycler = new Ll({
            ...
            fillFromConfig(t, e) {
                t.map(t => {
                    "|" == t ? this.items.add(new jl) : e.has(t) ? this.items.add(e.create(t)) : bs.a.warn("toolbarview-item-unavailable: The requested toolbar item is unavailable.", {name: t})
                })
            }
        }
        ...
        class Bl extends Ol {
            constructor(t, e, n) {
                super(t), this.toolbar = new zl(t), this.editable = new Dl(t, e, n), ml.extend(this.toolbar.template, {attributes: {class: ["ck-reset_all", "ck-rounded-corners"]}})
            }
        ...
        class Fl extends Zc {
            constructor(t, e) {
                super(e), Wn(t) && (this.sourceElement = t), this.data.processor = new el, this.model.document.createRoot();
                const n = new Bl(this.locale, this.editing.view, this.sourceElement);
                this.ui = new ul(this, n)
            }
        ...
        class ql extends ts {
            ...
            onDomEvent(t) {
                const e = {dataTransfer: new Hl(t.clipboardData ? t.clipboardData : t.dataTransfer)};
        ...
        class Yl extends Ul {
            ...
            init() {
                ...
                this._htmlDataProcessor = new el, n.addObserver(ql), this.listenTo(i, "clipboardInput", e => {
                    t.isReadOnly && e.stop()
                    ...
                    i.content.isEmpty || (i.dataTransfer.setData("text/html", this._htmlDataProcessor.toData(i.content)), i.dataTransfer.setData("text/plain", function t(e) {
                        ...
                        if (e.is("text") || e.is("textProxy")) n = e.data; else if (e.is("img") && e.hasAttribute("alt")) n = e.getAttribute("alt"); else {
                            ...
                            for (const o of e.getChildren()) {
                                const e = t(o);
                                i && (i.is("containerElement") || o.is("containerElement")) && (Wl.includes(i.name) || Wl.includes(o.name) ? n += "\n" : n += "\n\n"), n += e, i = o
                            }
                        }
                        return n
        ...
        class $l {
            ...
            forceDisabled(t) {
                this._disableStack.add(t), 1 == this._disableStack.size && (this.on("set:isEnabled", Gl, {priority: "highest"}), this.isEnabled = !1)
            }
                ...
                t.change(n => {
                    !function (t, e, n, i) {
                        ...
                        if (o) Kl(e, r.start); else {
                            ...
                            t.deleteContent(n, {leaveUnmerged: i}), i && (o ? Kl(e, n.focus) : e.setSelection(a, 0))
                        }
        ...
        class Zl extends Ul {
            ...
            init() {
                ...
                e.addObserver(Jl), t.commands.add("enter", new Ql(t)), this.listenTo(n, "enter", (n, i) => {
                ...
                t.change(n => {
                    !function (t, e, n) {
                        ...
                        if (i) td(e, o.end); else {
                            ...
                            t.deleteContent(n, {leaveUnmerged: i}), a ? td(e, n.focus) : i && e.setSelection(s, 0)
                        }
        ...
        class nd extends Ul {
            ...
            init() {
                ...
                }), i.addObserver(Jl), t.commands.add("shiftEnter", new Xl(t)), this.listenTo(o, "enter", (e, n) => {
        ...
        class od extends $l {
            constructor(t, e) {
                super(t), this._buffer = new id(t.model, e)
            }
        ...
        const sd = [wo("arrowUp"), wo("arrowRight"), wo("arrowDown"), wo("arrowLeft"), 9, 16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 45, 91, 93, 144, 145, 173, 174, 175, 176, 177, 178, 179, 255];
        for (let t = 112; t <= 135; t++) sd.push(t);
        ...
        class ld {
            ...
            handle(t, e) {
                if (function (t) {
                    ...
                    for (const e of t) if ("children" === e.type && !ad(e)) return !0;
                    return !1
            ...
            _handleContainerChildrenMutations(t, e) {
                ...
                if (f === h) return;
                const m = Qo(f, h), {firstChangeAt: g, insertions: p, deletions: b} = ud(m);
                let w = null;
            ...
            _handleTextMutation(t, e) {
                ...
                if (i === n) return;
                const o = Qo(i, n), {firstChangeAt: r, insertions: s, deletions: a} = ud(o);
                let c = null;
            ...
            _handleTextNodeInsertion(t) {
                ...
                const e = ad(t), n = this.editing.view.createPositionAt(t.node, e.index),
        ...
        class hd extends Ul {
            ...
            init() {
                const t = this.editor, e = new od(t, t.config.get("typing.undoStep") || 20);
        ...
        class fd extends $l {
            constructor(t, e) {
                super(t), this.direction = e, this._buffer = new id(t.model, t.config.get("typing.undoStep"))
            }
        ...
        class gd extends Ul {
            ...
            init() {
                const t = this.editor, e = t.editing.view, n = e.document;
                if (e.addObserver(md), t.commands.add("forwardDelete", new fd(t, "forward")), t.commands.add("delete", new fd(t, "backward")), this.listenTo(n, "delete", (n, i) => {
                    ...
                    this.listenTo(n, "delete", (e, n) => {
                        ...
                        const i = n.domTarget.ownerDocument.defaultView.getSelection();
                        i.collapse(t.anchorNode, t.anchorOffset), i.extend(t.focusNode, t.focusOffset), t = null
                    })
                }
            }
        }
        ...
        function yd(t, e, n) {
            ...
            for (; s < t.length;) {
                ...
                const a = e[o], c = vd(n, a, r.getContext(n, a, !0)), l = vd(a, n, r.getContext(a, n, !1));
            ...
            return Ad(t, o.nextBaseVersionB), Ad(e, o.nextBaseVersionA), {operationsA: t, operationsB: e}
        }
        ...
        kd(sc, sc, (t, e, n) => {
            if (t.key === e.key) {
                const i = t.range.getDifference(e.range).map(e => new sc(e, t.key, t.oldValue, t.newValue, 0)),
                    o = t.range.getIntersection(e.range);
                return o && n.aIsStrong && i.push(new sc(o, e.key, e.newValue, t.newValue, 0)), 0 == i.length ? [new bd(0)] : i
            }
            return [t]
        }), kd(sc, lc, (t, e) => {
            ...
            return i.isCollapsed || n.push(i), n.map(e => new sc(e, t.key, t.oldValue, t.newValue, t.baseVersion))
        }), kd(sc, cc, (t, e) => {
            return function (t, e) {
                ...
                return r
            }(t.range, e).map(e => new sc(e, t.key, t.oldValue, t.newValue, t.baseVersion))
        }), kd(sc, mc, (t, e) => {
            ...
            return n
        }), kd(lc, lc, (t, e, n) => t.position.isEqual(e.position) && n.aIsStrong ? [t] : (t.position = t.position._getTransformedByInsertOperation(e), [t])), kd(lc, cc, (t, e) => (t.position = t.position._getTransformedByMoveOperation(e), [t])), kd(lc, mc, (t, e) => (t.position = t.position._getTransformedBySplitOperation(e), [t])), kd(lc, fc, (t, e) => (t.position = t.position._getTransformedByMergeOperation(e), [t])), kd(dc, lc, (t, e) => (t.oldRange && (t.oldRange = t.oldRange._getTransformedByInsertOperation(e)[0]), t.newRange && (t.newRange = t.newRange._getTransformedByInsertOperation(e)[0]), [t])), kd(dc, dc, (t, e, n) => {
            if (t.name == e.name) {
                if (!n.aIsStrong) return [new bd(0)];
                t.oldRange = e.newRange ? e.newRange.clone() : null
            }
            return [t]
        }), kd(dc, fc, (t, e) => (t.oldRange && (t.oldRange = t.oldRange._getTransformedByMergeOperation(e)), t.newRange && (t.newRange = t.newRange._getTransformedByMergeOperation(e)), [t])), kd(dc, cc, (t, e, n) => {
            ...
            return [t]
        }), kd(fc, lc, (t, e) => (t.sourcePosition.hasSameParentAs(e.position) && (t.howMany += e.howMany), t.sourcePosition = t.sourcePosition._getTransformedByInsertOperation(e), t.targetPosition = t.targetPosition._getTransformedByInsertOperation(e), [t])), kd(fc, fc, (t, e, n) => {
            ...
            if (e.deletionPosition.hasSameParentAs(t.sourcePosition) && i.containsPosition(e.sourcePosition)) if ("remove" != t.type || n.forceWeakRemove) {
                ...
                const r = e.deletionPosition._getCombined(t.sourcePosition, t.targetPosition), s = new cc(i, 1, r, 0),
        ...
        }), kd(uc, lc, (t, e) => (t.position = t.position._getTransformedByInsertOperation(e), [t])), kd(uc, fc, (t, e) => t.position.isEqual(e.deletionPosition) ? (t.position = e.graveyardPosition.clone(), t.position.stickiness = "toNext", [t]) : (t.position = t.position._getTransformedByMergeOperation(e), [t])), kd(uc, cc, (t, e) => (t.position = t.position._getTransformedByMoveOperation(e), [t])), kd(uc, uc, (t, e, n) => {
            ...
            return [t]
        }), kd(mc, lc, (t, e) => (t.splitPosition.hasSameParentAs(e.position) && t.splitPosition.offset < e.position.offset && (t.howMany += e.howMany), t.splitPosition = t.splitPosition._getTransformedByInsertOperation(e), t.insertionPosition = mc.getInsertionPosition(t.splitPosition), [t])), kd(mc, fc, (t, e, n) => {
            if (!t.graveyardPosition && !n.bWasUndone && t.splitPosition.hasSameParentAs(e.sourcePosition)) {
                const n = e.graveyardPosition.path.slice();
                n.push(0);
                const i = new Gs(e.graveyardPosition.root, n),
                    o = mc.getInsertionPosition(new Gs(e.graveyardPosition.root, n)), r = new mc(i, 0, null, 0);
        ...
        class Sd extends $l {
            ...
            _restoreSelection(t, e, n) {
                ...
                for (const e of t) {
                    const t = Ed(e, n).find(t => t.start.root != o.graveyard);
                    t && r.push(t)
                }
                r.length && i.change(t => {
        ...
        class Ld extends Nl {
            ...
            _createLabelView(t) {
                const e = new Nl, n = this.bindTemplate;
        ...
        var Vd = n(24), jd = n.n(Vd), zd = n(25), Bd = n.n(zd);

        class Fd extends Ul {
            init() {
                const t = this.editor.t;
                this._addButton("undo", t("ch"), "CTRL+Z", jd.a), this._addButton("redo", t("ci"), "CTRL+Y", Bd.a)
            }

            _addButton(t, e, n, i) {
                const o = this.editor;
                o.ui.componentFactory.add(t, r => {
                    const s = o.commands.get(t), a = new Ld(r);
                    return a.set({
                        label: e,
                        icon: i,
                        keystroke: n,
        ...
        class Gd extends $l {
            refresh() {
                const t = Hd(this.editor.model.document.selection.getSelectedBlocks());
            ...
            execute(t = {}) {
                ...
                e.change(t => {
                    ...
                    Yd(i) || o === i || !i ? function (t, e) {
                        for (const n of t) e.removeAttribute($d, n)
                    }(e, t) : function (t, e, n) {
                        for (const i of t) e.setAttribute($d, n, i)
                    }(e, t, i)
                })
            }
        ...
        class Qd extends Ul {
            constructor(t) {
                super(t), t.config.define("alignment", {options: [...qd]})
            }

            init() {
                const t = this.editor, e = t.model.schema, n = t.config.get("alignment.options").filter(Wd);
                e.extend("$block", {allowAttributes: "alignment"}), t.model.schema.setAttributeProperties("alignment", {isFormatting: !0});
                const i = function (t) {
        ...
        function Jd({element: t, target: e, positions: n, limiter: i, fitInViewport: o}) {
            W(e) && (e = e()), W(i) && (i = i());
            const r = function (t) {
                ...
                return null
            }(t.parentElement), s = new Cs(t), a = new Cs(e);
            let c, l;
            if (i || o) {
                ...
                }(n, a, s, t, e) || Zd(n[0], a, s)
            } else [l, c] = Zd(n[0], a, s);
            let {left: d, top: u} = Xd(c);
            if (r) {
                const t = Xd(new Cs(r)), e = xs(r);
        ...
        class tu extends Nl {
            constructor(t, e, n) {
                ...
                this.buttonView = e, this.panelView = n, this.set("isOpen", !1), this.set("isEnabled", !0), this.set("class"), this.set("panelPosition", "auto"), this.focusTracker = new ol, this.keystrokes = new Kc, this.setTemplate({
                    tag: "div",
            ...
            render() {
                super.render(), this.listenTo(this.buttonView, "open", () => {
                    ...
                    if (this.isOpen) if ("auto" === this.panelPosition) {
                        const t = tu.defaultPanelPositions;
                        this.panelView.position = Jd({
        ...
        class iu extends Ld {
            ...
            _createArrowView() {
                const t = new Rd;
                return t.content = nu.a, t.extendTemplate({attributes: {class: "ck-dropdown__arrow"}}), t
            }
        }
        ...
        class ou extends Nl {
            constructor() {
                super(), this.items = this.createCollection(), this.focusTracker = new ol, this.keystrokes = new Kc, this._focusCycler = new Ll({
                    focusables: this.items,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
        ...
        function cu({emitter: t, activator: e, callback: n, contextElements: i}) {
        ...
        function lu(t, e = iu) {
            const n = new e(t), i = new Kd(t), o = new tu(t, n, i);
        ...
        function uu(t, e) {
            const n = t.locale, i = t.listView = new ou(n);
            i.items.bindTo(e).using(({type: t, model: e}) => {
                if ("separator" === t) return new su(n);
                if ("button" === t || "switchbutton" === t) {
                    const i = new ru(n);
                    let o;
                    return (o = "button" === t ? new Ld(n) : new au(n)).bind(...Object.keys(e)).to(e), o.delegate("execute").to(i), i.children.add(o), i
                }
            }), t.panelView.children.add(i), i.items.delegate("execute").to(t)
        }

        var hu = n(15), fu = n.n(hu), mu = n(26), gu = n.n(mu), pu = n(27), bu = n.n(pu), wu = n(28), ku = n.n(wu);
        const _u = new Map([["left", fu.a], ["right", gu.a], ["center", bu.a], ["justify", ku.a]]);
        ...
        class vu extends Ul {
            ...
            init() {
                ...
                i.filter(Wd).forEach(t => this._addButton(t)), e.add("alignment", t => {
                    const o = lu(t), r = i.map(t => e.create(`alignment:${t}`));
                    du(o, r), o.buttonView.set({
                        label: n("f"),
                        tooltip: !0
                    }), o.toolbarView.isVertical = !0, o.extendTemplate({attributes: {class: "ck-alignment-dropdown"}});
                    const s = fu.a;
            ...
            _addButton(t) {
                ...
                e.ui.componentFactory.add(`alignment:${t}`, n => {
                    const i = e.commands.get("alignment"), o = new Ld(n);
                    return o.set({
        ...
        n(86);
        const Pu = "fontSize", Mu = "fontFamily";
        ...
        function Ou(t) {
            ...
            return isNaN(e) ? void 0 : function (t) {
                return {title: String(t), model: t, view: {name: "span", styles: {"font-size": `${t}px`}, priority: 7}}
            }(e)
        }

        class Ru extends Ul {
            constructor(t) {
                super(t), t.config.define(Pu, {options: ["tiny", "small", "default", "big", "huge"]});
                const e = Iu(this.editor.config.get("fontSize.options")).filter(t => t.model), n = Su(Pu, e);
                t.conversion.attributeToElement(n), t.commands.add(Pu, new Eu(t))
            }

            init() {
                const t = this.editor;
                t.model.schema.extend("$text", {allowAttributes: Pu}), t.model.schema.setAttributeProperties(Pu, {isFormatting: !0})
            }
        }
        ...
        ci(Du, Fi);
        var Lu = n(30), Vu = n.n(Lu);
        n(88);

        class ju extends Ul {
            init() {
                const t = this.editor, e = t.t, n = this._getLocalizedOptions(), i = t.commands.get(Pu);
                t.ui.componentFactory.add(Pu, o => {
                    const r = lu(o);
            ...
            _getLocalizedOptions() {
                const t = this.editor, e = t.t,
                    n = {Default: e("h"), Tiny: e("j"), Small: e("k"), Big: e("l"), Huge: e("m")};
                return Iu(t.config.get(Pu).options).map(t => {
                    const e = n[t.title];
        ...
        function Fu(t) {
            return "object" == typeof t ? t : "default" === t ? {
                ...
                const e = t.replace(/"|'/g, "").split(","), n = e[0], i = e.map(Uu).join(", ");
        ...
        class Hu extends Ul {
            constructor(t) {
                super(t), t.config.define(Mu, {options: ["default", "Arial, Helvetica, sans-serif", "Courier New, Courier, monospace", "Georgia, serif", "Lucida Sans Unicode, Lucida Grande, sans-serif", "Tahoma, Geneva, sans-serif", "Times New Roman, Times, serif", "Trebuchet MS, Helvetica, sans-serif", "Verdana, Geneva, sans-serif"]})
            }

            init() {
                const t = this.editor;
                t.model.schema.extend("$text", {allowAttributes: Mu}), t.model.schema.setAttributeProperties(Mu, {isFormatting: !0});
                const e = Bu(t.config.get("fontFamily.options")).filter(t => t.model), n = Su(Mu, e);
        ...
        class Yu extends Ul {
            init() {
                const t = this.editor, e = t.t, n = this._getLocalizedOptions(), i = t.commands.get(Mu);
                t.ui.componentFactory.add(Mu, o => {
                    const r = lu(o);
                    return uu(r, function (t, e) {
                        const n = new oo;
                        for (const i of t) {
                            const t = {
                                type: "button",
                                model: new Du({commandName: Mu, commandParam: i.model, label: i.title, withText: !0})
                            };
            ...
            _getLocalizedOptions() {
                const t = this.editor, e = t.t;
                return Bu(t.config.get(Mu).options).map(t => ("Default" === t.title && (t.title = e("h")), t))
            }
        }
                    ...
                    if (n.isCollapsed) {
                        ...
                        if (n.hasAttribute("highlight")) {
                            const n = t => t.item.hasAttribute("highlight") && t.item.getAttribute("highlight") === this.value,
                                ...
                                r = e.getLastMatchingPosition(n), s = t.createRange(o, r);
        ...
        class th extends Ul {
            ...
            _addRemoveHighlightButton() {
                const t = this.editor.t;
                this._addButton("removeHighlight", t("v"), Tu.a)
            }
            ...
            _addButton(t, e, n, i, o = (() => {
                ...
                r.ui.componentFactory.add(t, t => {
                    const s = new Ld(t), a = this.localizedOptionTitles[e] ? this.localizedOptionTitles[e] : e;
            ...
            _addDropdown(t) {
                const e = this.editor, n = e.t, i = e.ui.componentFactory, o = t[0],
                    r = t.reduce((t, e) => (t[e.model] = e, t), {});
                i.add("highlight", s => {
                    const a = e.commands.get("highlight"), c = lu(s, Xu), l = c.buttonView;
                    l.set({
                        tooltip: n("w"),
                        lastExecuted: o.model,
                        commandValue: o.model
                    }), l.bind("icon").to(a, "value", t => eh(u(t, "type"))), l.bind("color").to(a, "value", t => u(t, "color")), l.bind("commandValue").to(a, "value", t => u(t, "model")), l.bind("isOn").to(a, "value", t => !!t), l.delegate("execute").to(c);
                    const d = t.map(t => {
                    ...
                    return c.bind("isEnabled").toMany(d, "isEnabled", (...t) => t.some(t => t)), d.push(new jl), d.push(i.create("removeHighlight")), du(c, d), function (t) {
        ...
        class oh extends Ul {
            ...
            createLoader(t) {
                ...
                const e = new rh(Promise.resolve(t), this.createUploadAdapter);
            ...
            destroyLoader(t) {
                const e = t instanceof rh ? t : this.getLoader(t);
            ...
            _updatePendingAction() {
                const t = this.editor.plugins.get(nh);
                if (this.loaders.length) {
                    if (!this._pendingAction) {
                        const e = this.editor.t, n = t => `${e("bx")} ${parseInt(t)}%.`;
        ...
        ci(rh, Fi);
        const sh = "ckCsrfToken", ah = 40, ch = "abcdefghijklmnopqrstuvwxyz0123456789";
        ...
        function lh() {
            ...
            return t && t.length == ah || (t = function (t) {
                ...
                for (let t = 0; t < n.length; t++) {
                    const i = ch.charAt(n[t] % ch.length);
        ...
        class dh extends Ul {
            ...
            init() {
                ...
                t && (this.editor.plugins.get(oh).createUploadAdapter = (e => new uh(e, t, this.editor.t)))
            }
        }
        ...
        class fh {
            constructor(t, e, n) {
                ...
                e instanceof RegExp ? i = e : r = e, "string" == typeof n ? o = n : s = n, r = r || (t => {
                    ...
                    }(c).slice(0, i.focus.offset), d = r(l), u = mh(c, d.format, t.model), h = mh(c, d.remove, t.model);
        ...
        class wh extends Ul {
            init() {
                const t = this.editor;
                t.model.schema.extend("$text", {allowAttributes: bh}), t.model.schema.setAttributeProperties(bh, {isFormatting: !0}), t.conversion.attributeToElement({
                    model: bh,
                    view: "strong",
        ...
        var kh = n(34), _h = n.n(kh);
        const vh = "bold";

        class yh extends Ul {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add(vh, n => {
                    const i = t.commands.get(vh), o = new Ld(n);
                    return o.set({
                        label: e("o"),
                        icon: _h.a,
                        keystroke: "CTRL+B",
                        tooltip: !0
                    }), o.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(o, "execute", () => t.execute(vh)), o
                })
            }
        }
        ...
        class Ah extends Ul {
            init() {
                const t = this.editor;
                t.model.schema.extend("$text", {allowAttributes: xh}), t.model.schema.setAttributeProperties(xh, {isFormatting: !0}), t.conversion.attributeToElement({
                    model: xh,
                    view: "i",
        ...
        class Mh extends Ul {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add(Ph, n => {
                    const i = t.commands.get(Ph), o = new Ld(n);
                    return o.set({
                        label: e("n"),
                        icon: Th.a,
                        keystroke: "CTRL+I",
                        tooltip: !0
                    }), o.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(o, "execute", () => t.execute(Ph)), o
                })
            }
        }

        const Sh = "strikethrough";

        class Eh extends Ul {
            init() {
                const t = this.editor;
                t.model.schema.extend("$text", {allowAttributes: Sh}), t.model.schema.setAttributeProperties(Sh, {isFormatting: !0}), t.conversion.attributeToElement({
                    model: Sh,
                    view: "s",
        ...
        const Oh = "strikethrough";

        class Rh extends Ul {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add(Oh, n => {
                    const i = t.commands.get(Oh), o = new Ld(n);
                    return o.set({
                        label: e("x"),
                        icon: Nh.a,
                        keystroke: "CTRL+SHIFT+X",
                        tooltip: !0
                    }), o.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(o, "execute", () => t.execute(Oh)), o
                })
            }
        }
        ...
        class Lh extends Ul {
            init() {
                const t = this.editor;
                t.model.schema.extend("$text", {allowAttributes: Dh}), t.model.schema.setAttributeProperties(Dh, {isFormatting: !0}), t.conversion.attributeToElement({
                    model: Dh,
                    view: "u",
        ...
        var Vh = n(37), jh = n.n(Vh);
        const zh = "underline";

        class Bh extends Ul {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add(zh, n => {
                    const i = t.commands.get(zh), o = new Ld(n);
                    return o.set({
                        label: e("z"),
                        icon: jh.a,
                        keystroke: "CTRL+U",
                        tooltip: !0
                    }), o.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(o, "execute", () => t.execute(zh)), o
                })
            }
        }
        ...
        class Fh extends $l {
            ...
            execute(t = {}) {
                ...
                e.change(t => {
                    if (r) {
                        const e = o.filter(t => Uh(t) || qh(n, t));
                        this._applyQuote(t, e)
                    } else this._removeQuote(t, o.filter(Uh))
                })
            }

            _getValue() {
                const t = Hd(this.editor.model.document.selection.getTopMostBlocks());
                return !(!t || !Uh(t))
            }
        ...
        class Gh extends Ul {
            init() {
                ...
                t.ui.componentFactory.add("blockQuote", n => {
                    const i = t.commands.get("blockQuote"), o = new Ld(n);
                    return o.set({
                        label: e("aa"),
                        icon: $h.a,
                        tooltip: !0
        ...
        class Jh extends Ul {
            ...
            init() {
                ...
                e.add("ckfinder", e => {
                    const i = t.commands.get("ckfinder"), o = new Ld(e);
                    return o.set({
                        label: n("y"),
                        icon: Kh.a,
                        tooltip: !0
                ...
                n.language || (n.language = t.locale.language), n.onInit = (e => {
                    i && i(), e.on("files:choose", n => {
                        ...
                        if (n) tf(t, [n]); else {
                            ...
                            e.showWarning(n("cv"), {title: n("cw"), namespace: "ckfinder"})
                        }
                    })
                }), window.CKFinder[e](n)
            }
        ...
        function tf(t, e) {
            if (t.commands.get("imageUpload").isEnabled) t.execute("imageInsert", {source: e}); else {
                const e = t.plugins.get("Notification"), n = t.locale.t;
                e.showWarning(n("cx"), {title: n("cy"), namespace: "ckfinder"})
            }
        }
        ...
        class of {
            constructor(t, e, n) {
                ...
                this.file = function (t) {
                    ...
                    try {
                        const n = t.match(nf)[1], i = atob(t.replace(nf, "")), o = [];
        ...
        ci(of, ei);
        const rf = {refreshInterval: 36e5, autoRefresh: !0};
        ...
        class sf {
            constructor(t, e = rf) {
                ...
                })(t), this._options = Object.assign({}, rf, e)
            }
        ...
        class cf extends Ul {
            ...
            init() {
                ...
                if (this.tokenUrl) return this.token = new cf.Token(this.tokenUrl), this.token.init();
                this.token = null
            }
        }
        ...
        class lf extends Ul {
            ...
            init() {
                const t = this.editor, e = t.plugins.get(cf), n = e.token, i = e.uploadUrl;
                n && (this._uploadGateway = new lf._UploadGateway(n, i), t.plugins.get(oh).createUploadAdapter = (t => new df(this._uploadGateway, t)))
            }
        }
        ...
        lf._UploadGateway = class {
            ...
            upload(t) {
                return new of(t, this._token, this._apiAddress)
            }
        };
        ...
        class ff {
            ...
            add(t, e) {
                ...
                const o = n[0];
                i === o || mf(i, o) || this.fire("change:top", {oldDescriptor: i, newDescriptor: o, writer: e})
            }
        ...
        function mf(t, e) {
            return t && e && t.priority == e.priority && pf(t.classes) == pf(e.classes)
        }

        function gf(t, e) {
            return t.priority > e.priority || !(t.priority < e.priority) && pf(t.classes) > pf(e.classes)
        }
        ...
        ci(ff, ei);
        var bf = n(40), wf = n.n(bf);
        const kf = "ck-widget", _f = "ck-widget_selected";
        ...
        function yf(t, e, n = {}) {
            return mo.isEdge || e.setAttribute("contenteditable", "false", t), e.addClass(kf, t), e.setCustomProperty("widget", !0, t), t.getFillerOffset = Tf, n.label && function (t, e, n) {
                ...
                const n = e.createUIElement("div", {class: "ck ck-widget__selection-handler"}, function (t) {
                    ...
                    return n.set("content", wf.a), n.render(), e.appendChild(n.element), e
                });
        ...
        function Pf(t) {
            ...
            return e && function (t) {
                return !!t.getCustomProperty("image") && vf(t)
            }(e) ? e : null
        }
        ...
        function Sf(t, e, n = {}) {
            const i = t.createElement("image", n), o = Cf(e.document.selection, e);
        ...
        class If extends $l {
            refresh() {
                this.isEnabled = Ef(this.editor.model)
            }
        ...
        class Nf extends Ul {
            init() {
                ...
                t.editing.view.addObserver(uf), e.register("image", {
                    isObject: !0,
                    isBlock: !0,
                    allowWhere: "$block",
                    ...
                    model: "image", view: (t, e) => (function (t, e, n) {
                        return e.setCustomProperty("image", !0, t), yf(t, e, {
                            label: function () {
                ...
                }), i.for("downcast").add(hf("src")).add(hf("alt")).add(function () {
                    return e => {
        ...
        class Lf extends Ul {
            ...
            init() {
                ...
                this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (t, e, n) => {
                    ...
                    for (const t of o.getRanges()) for (const e of t) {
                        const t = e.item;
                        vf(t) && !Vf(t, s) && (i.addClass(_f, t), this._previouslySelected.add(t), s = t, t == r && i.setSelection(o.getRanges(), {
                            fake: !0,
                            label: xf(r)
                        }))
                    }
                }, {priority: "low"}), t.addObserver(Rf), this.listenTo(e, "mousedown", (...t) => this._onMousedown(...t)), this.listenTo(e, "keydown", (...t) => this._onKeydown(...t), {priority: "high"}), this.listenTo(e, "delete", (t, e) => {
            ...
            _onMousedown(t, e) {
                ...
                if (!vf(r) && !(r = r.findAncestor(vf))) return;
            ...
            _clearPreviouslySelectedWidgets(t) {
                for (const e of this._previouslySelected) t.removeClass(_f, e);
        ...
        class jf extends $l {
            refresh() {
                ...
                this.isEnabled = Mf(t), Mf(t) && t.hasAttribute("alt") ? this.value = t.getAttribute("alt") : this.value = !1
            }
        ...
        class Bf extends Nl {
            ...
            _createStatusView(t) {
                const e = new Nl(this.locale), n = this.bindTemplate;
                return e.setTemplate({
                    tag: "div",
                    attributes: {
        ...
        var Hf = n(7), qf = n.n(Hf), Wf = n(8), Yf = n.n(Wf);
        n(102);
        ...
        class $f extends Nl {
            constructor(t) {
                ...
                this.focusTracker = new ol, this.keystrokes = new Kc, this.labeledInput = this._createLabeledInputView(), this.saveButtonView = this._createButton(e("ce"), qf.a, "ck-button-save"), this.saveButtonView.type = "submit", this.cancelButtonView = this._createButton(e("cf"), Yf.a, "ck-button-cancel", "cancel"), this._focusables = new hl, this._focusCycler = new Ll({
            ...
            render() {
                super.render(), this.keystrokes.listenTo(this.element), Uf({view: this}), [this.labeledInput, this.saveButtonView, this.cancelButtonView].forEach(t => {
            ...
            _createLabeledInputView() {
                const t = this.locale.t, e = new Bf(this.locale, Ff);
        ...
        n(104);
        const Qf = Gf("px"), Kf = nr.document.body;
        ...
        class Jf extends Nl {
            constructor(t) {
                ...
                this.set("top", 0), this.set("left", 0), this.set("position", "arrow_nw"), this.set("isVisible", !1), this.set("withArrow", !0), this.set("class"), this.content = this.createCollection(), this.setTemplate({
                    ...
                    attributes: {
                        ...
                        style: {top: e.to("top", Qf), left: e.to("left", Qf)}
                    },
            ...
            attachTo(t) {
                this.show();
                const e = Jf.defaultPositions, n = Object.assign({}, {
                    ...
                    limiter: Kf,
                    fitInViewport: !0
                }, t), i = Jf._getOptimalPosition(n), o = parseInt(i.left), r = parseInt(i.top), s = i.name;
            ...
            _startPinning(t) {
                this.attachTo(t);
                const e = Zf(t.target), n = t.limiter ? Zf(t.limiter) : Kf;
        ...
        function Zf(t) {
            return Wn(t) ? t : ys(t) ? t.commonAncestorContainer : "function" == typeof t ? Zf(t()) : null
        }

        function Xf(t, e) {
            return t.top - e.height - Jf.arrowVerticalOffset
        }

        function tm(t) {
            return t.bottom + Jf.arrowVerticalOffset
        }

        Jf.arrowHorizontalOffset = 25, Jf.arrowVerticalOffset = 10, Jf._getOptimalPosition = Jd, Jf.defaultPositions = {
            northArrowSouth: (t, e) => ({top: Xf(t, e), left: t.left + t.width / 2 - e.width / 2, name: "arrow_s"}),
            northArrowSouthEast: (t, e) => ({
                top: Xf(t, e),
                left: t.left + t.width / 2 - e.width + Jf.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            northArrowSouthWest: (t, e) => ({
                top: Xf(t, e),
                left: t.left + t.width / 2 - Jf.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            northWestArrowSouth: (t, e) => ({top: Xf(t, e), left: t.left - e.width / 2, name: "arrow_s"}),
            northWestArrowSouthWest: (t, e) => ({
                top: Xf(t, e),
                left: t.left - Jf.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            northWestArrowSouthEast: (t, e) => ({
                top: Xf(t, e),
                left: t.left - e.width + Jf.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            northEastArrowSouth: (t, e) => ({top: Xf(t, e), left: t.right - e.width / 2, name: "arrow_s"}),
            northEastArrowSouthEast: (t, e) => ({
                top: Xf(t, e),
                left: t.right - e.width + Jf.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            northEastArrowSouthWest: (t, e) => ({
                top: Xf(t, e),
                left: t.right - Jf.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            southArrowNorth: (t, e) => ({top: tm(t), left: t.left + t.width / 2 - e.width / 2, name: "arrow_n"}),
            ...
            southWestArrowNorth: (t, e) => ({top: tm(t), left: t.left - e.width / 2, name: "arrow_n"}),
            ...
            southEastArrowNorth: (t, e) => ({top: tm(t), left: t.right - e.width / 2, name: "arrow_n"}),
        ...
        var em = n(41), nm = n.n(em), im = n(42), om = n.n(im);
        n(106), n(108);
        const rm = Gf("px");
        ...
        class sm extends Ul {
            ...
            constructor(t) {
                ...
                }), this.set("visibleView", null), this.view = new Jf(t.locale), t.ui.view.body.add(this.view), t.ui.focusTracker.add(this.view.element), this._viewToStack = new Map, this._idToStack = new Map, this.set("_numberOfStacks", 0), this.set("_singleViewMode", !1), this._rotatorView = this._createRotatorView(), this._fakePanelsView = this._createFakePanelsView()
            }
            ...
            _createRotatorView() {
                const t = new am(this.editor.locale), e = this.editor.locale.t;
            ...
            _createFakePanelsView() {
                const t = new cm(this.editor.locale, this.view);
        ...
        class am extends Nl {
            constructor(t) {
                ...
                this.set("isNavigationVisible", !0), this.focusTracker = new ol, this.buttonPrevView = this._createButtonView(e("cl"), nm.a), this.buttonNextView = this._createButtonView(e("cm"), om.a), this.content = this.createCollection(), this.setTemplate({
                    tag: "div",
        ...
        var lm = n(43), dm = n.n(lm);

        function um(t) {
            const e = t.editing.view, n = Jf.defaultPositions;
            return {
        ...
        class hm extends Ul {
            ...
            _createButton() {
                ...
                t.ui.componentFactory.add("imageTextAlternative", n => {
                    const i = t.commands.get("imageTextAlternative"), o = new Ld(n);
                    return o.set({
                        label: e("cu"),
                        icon: dm.a,
                        tooltip: !0
            ...
            _createForm() {
                ...
                this._balloon = this.editor.plugins.get("ContextualBalloon"), this._form = new $f(t.locale), this._form.render(), this.listenTo(this._form, "submit", () => {
                    ...
                    Pf(e.selection) ? this._isVisible && function (t) {
                        const e = t.plugins.get("ContextualBalloon");
                        if (Pf(t.editing.view.document.selection)) {
                            const n = um(t);
                            e.updatePosition(n)
                        }
                    }(t) : this._hideForm(!0)
        ...
        class gm extends Nl {
            constructor(t) {
                super(t), this.buttonView = new Ld(t), this._fileInputView = new pm(t), this._fileInputView.bind("acceptedType").to(this), this._fileInputView.bind("allowMultipleFiles").to(this), this._fileInputView.delegate("done").to(this), this.setTemplate({
                    tag: "span",
        ...
        var ym = n(45), xm = n.n(ym);
        n(112), n(114), n(116);

        class Am extends Ul {
            constructor(t) {
                super(t), this.placeholder = "data:image/svg+xml;utf8," + encodeURIComponent(xm.a)
            }
            ...
            uploadStatusChange(t, e, n) {
                ...
                if (!n.consumable.consume(e.item, t.name)) return;
                const s = i.plugins.get(oh), a = r ? e.attributeNewValue : null, c = this.placeholder,
                    l = i.editing.mapper.toViewElement(o), d = n.writer;
                if ("reading" == a) return Cm(l, d), void Tm(c, l, d);
                if ("uploading" == a) {
                    const t = s.loaders.get(r);
                    return Cm(l, d), void (t ? (Pm(l, d), function (t, e, n, i) {
                        const o = function (t) {
        ...
        function Tm(t, e, n) {
            ...
            i.getAttribute("src") !== t && n.setAttribute("src", t, i), Mm(e, "placeholder") || n.insert(n.createPositionAfter(i), function (t) {
        ...
        function Pm(t, e) {
            t.hasClass("ck-image-upload-placeholder") && e.removeClass("ck-image-upload-placeholder", t), Sm(t, e, "placeholder")
        }
        ...
        class Im extends $l {
            ...
            execute(t) {
                const e = this.editor, n = e.model, i = e.plugins.get(oh);
                n.change(e => {
                    const o = Array.isArray(t.file) ? t.file : [t.file];
                    for (const t of o) Nm(e, n, i, t)
                })
            }
        }
        ...
        class Om extends Ul {
            ...
            init() {
                const t = this.editor, e = t.model.document, n = t.model.schema, i = t.conversion,
                    o = t.plugins.get(oh);
                n.extend("image", {allowAttributes: ["uploadId", "uploadStatus"]}), t.commands.add("imageUpload", new Im(t)), i.for("upcast").attributeToAttribute({
                    view: {
                        name: "img",
                        key: "uploadId"
                    }, model: "uploadId"
                    ...
                    const i = Array.from(n.dataTransfer.files).filter(t => !!t && km(t)),
            ...
            _readAndUpload(t, e) {
                const n = this.editor, i = n.model, o = n.locale.t, r = n.plugins.get(oh), s = n.plugins.get(Zh);
        ...
        class Dm extends $l {
            refresh() {
                const t = this.editor.model, e = Hd(t.document.selection.getSelectedBlocks());
                this.value = !!e && e.is("paragraph"), this.isEnabled = !!e && Lm(e, t.schema)
            }
            ...
            execute(t = {}) {
                ...
                e.change(i => {
                    ...
                    for (const t of o) !t.is("paragraph") && Lm(t, e.schema) && i.rename(t, "paragraph")
                })
            }
        }
        ...
        class Vm extends Ul {
            ...
            init() {
                ...
                t.commands.add("paragraph", new Dm(t)), e.schema.register("paragraph", {inheritAllFrom: "$block"}), t.conversion.elementToElement({
                    model: "paragraph",
                    view: "p"
                }), t.conversion.for("upcast").elementToElement({
                    model: (t, e) => Vm.paragraphLikeElements.has(t.name) ? t.isEmpty ? null : e.createElement("paragraph") : null,
                    converterPriority: "low"
                }), n.upcastDispatcher.on("element", (t, e, n) => {
                    n.consumable.test(e.viewItem, {name: e.viewItem.name}) && zm(e.viewItem, e.modelCursor, n.schema) && Object.assign(e, jm(e.viewItem, e.modelCursor, n))
                }, {priority: "low"}), n.upcastDispatcher.on("text", (t, e, n) => {
                    e.modelRange || zm(e.viewItem, e.modelCursor, n.schema) && Object.assign(e, jm(e.viewItem, e.modelCursor, n))
        ...
        Vm.paragraphLikeElements = new Set(["blockquote", "dd", "div", "dt", "h1", "h2", "h3", "h4", "h5", "h6", "li", "p", "td"]);
        ...
        class Bm extends $l {
            ...
            refresh() {
                const t = Hd(this.editor.model.document.selection.getSelectedBlocks());
                this.value = !!t && this.modelElements.includes(t.name) && t.name, this.isEnabled = !!t && this.modelElements.some(e => Fm(t, e, this.editor.model.schema))
            }

            execute(t) {
                const e = this.editor.model, n = e.document, i = t.value;
                e.change(t => {
                    const o = Array.from(n.selection.getSelectedBlocks()).filter(t => Fm(t, i, e.schema));
        ...
        class Hm extends Ul {
            ...
            init() {
                ...
                for (const i of e) i.model !== Um && (t.model.schema.register(i.model, {inheritAllFrom: "$block"}), t.conversion.elementToElement(i), n.push(i.model));
                this._addDefaultH1Conversion(t), t.commands.add("heading", new Bm(t, n))
            }
            ...
            afterInit() {
                ...
                e && this.listenTo(e, "afterExecute", (e, i) => {
                    ...
                    n.some(t => o.is(t.model)) && !o.is(Um) && 0 === o.childCount && i.writer.rename(o, Um)
                })
            }
        ...
        class qm extends Ul {
            init() {
                ...
                t.ui.componentFactory.add("heading", e => {
                    ...
                    for (const t of n) {
                        const e = {type: "button", model: new Du({label: t.title, class: t.class, withText: !0})};
        ...
        class $m extends Ul {
            init() {
                ...
                i.downcastDispatcher.on("insert:caption", Gm(t => t.createContainerElement("figcaption"), !1));
                const s = function (t, e) {
                    return n => {
                        const i = n.createEditableElement("figcaption");
                        return n.setCustomProperty("imageCaption", !0, i), al({view: t, element: i, text: e}), Af(i, n)
                    }
                }(e, r("am"));
                o.downcastDispatcher.on("insert:caption", Gm(s)), o.downcastDispatcher.on("insert", this._fixCaptionVisibility(t => t.item), {priority: "high"}), o.downcastDispatcher.on("remove", this._fixCaptionVisibility(t => t.position.parent), {priority: "high"}), e.document.registerPostFixer(t => this._updateCaptionVisibility(t))
            }
            ...
            _updateCaptionVisibility(t) {
                ...
                const s = Qm(o.getFirstPosition().parent);
                if (s && (i = e.toViewElement(s)), i) return n ? n === i ? Jm(i, t) : (Km(n, t), this._lastSelectedCaption = i, Jm(i, t)) : (this._lastSelectedCaption = i, Jm(i, t));
                if (n) {
                    const e = Km(n, t);
            ...
            _fixCaptionVisibility(t) {
                return (e, n, i) => {
                    const o = Qm(t(n)), r = this.editor.editing.mapper, s = i.writer;
                    if (o) {
            ...
            _insertMissingModelCaptionElement(t) {
                ...
                for (const t of n) if ("insert" == t.type && "$text" != t.name) {
                    ...
                    if (n.is("image") && !Wm(n) && i.push(n), !n.is("image") && n.childCount) for (const t of e.createRangeIn(n).getItems()) t.is("image") && !Wm(t) && i.push(t)
                }
        ...
        class Zm extends $l {
            ...
            refresh() {
                const t = this.editor.model.document.selection.getSelectedElement();
                if (this.isEnabled = Mf(t), t) if (t.hasAttribute("imageStyle")) {
        ...
        var tg = n(16), eg = n.n(tg), ng = n(17), ig = n.n(ng), og = n(18), rg = n.n(og), sg = n(13), ag = n.n(sg);
        const cg = {
            full: {name: "full", title: "Full size image", icon: eg.a, isDefault: !0},
            side: {name: "side", title: "Side image", icon: ag.a, className: "image-style-side"},
            alignLeft: {
                name: "alignLeft",
        ...
        }, lg = {full: eg.a, left: ig.a, right: ag.a, center: rg.a};
        ...
        function ug(t) {
            if ("string" == typeof t) {
                const e = t;
                cg[e] ? t = Object.assign({}, cg[e]) : (bs.a.warn("image-style-not-found: There is no such image style of given name.", {name: e}), t = {name: e})
            } else if (cg[t.name]) {
                const e = cg[t.name], n = Object.assign({}, t);
                for (const i in e) t.hasOwnProperty(i) || (n[i] = e[i]);
                t = n
            }
            return "string" == typeof t.icon && lg[t.icon] && (t.icon = lg[t.icon]), t
        }
        ...
        class hg extends Ul {
            ...
            init() {
                ...
                const o = dg(t.config.get("image.styles"));
                e.extend("image", {allowAttributes: "imageStyle"});
                const r = function (t) {
                    return (e, n, i) => {
                        if (!i.consumable.consume(n.item, e.name)) return;
                        const o = Xm(n.attributeNewValue, t), r = Xm(n.attributeOldValue, t),
                ...
                i.downcastDispatcher.on("attribute:imageStyle:image", r), n.downcastDispatcher.on("attribute:imageStyle:image", r), n.upcastDispatcher.on("element:figure", function (t) {
                    ...
                    return (t, n, i) => {
                        ...
                        const o = n.viewItem, r = Hd(n.modelRange.getItems());
                ...
                }(o), {priority: "low"}), t.commands.add("imageStyle", new Zm(t, o))
            }
        }
        ...
        class fg extends Ul {
            ...
            init() {
                const t = function (t, e) {
                    ...
                    return t
                }(dg(this.editor.config.get("image.styles")), this.localizedDefaultStylesTitles);
            ...
            _createButton(t) {
                ...
                e.ui.componentFactory.add(n, n => {
                    const i = e.commands.get("imageStyle"), o = new Ld(n);
                    return o.set({
                        label: t.title,
                        icon: t.icon,
                        tooltip: !0
        ...
        class mg extends Ul {
            ...
            register(t, {items: e, getRelatedElement: n, balloonClassName: i = "ck-toolbar-container"}) {
                const o = this.editor, r = new zl;
                if (this._toolbarDefinitions.has(t)) throw new Gn.b("widget-toolbar-duplicated: Toolbar with the given id was already added.", this, {toolbarId: t});
            ...
            _showToolbar(t, e) {
                this._isToolbarVisible(t) ? function (t, e) {
                    const n = t.plugins.get("ContextualBalloon"), i = gg(t, e);
                    n.updatePosition(i)
                }(this.editor, e) : this._isToolbarInBalloon(t) || this._balloon.add({
                    view: t.view,
                    position: gg(this.editor, e),
        ...
        function gg(t, e) {
            const n = t.editing.view, i = Jf.defaultPositions;
            return {
        ...
        function pg(t, e, n) {
            return n.createRange(bg(t, e, !0, n), bg(t, e, !1, n))
        }
                ...
                n.change(e => {
                    if (i.isCollapsed) {
                        ...
                        if (i.hasAttribute("linkHref")) {
                            const a = pg(s, i.getAttribute("linkHref"), n);
        ...
        class kg extends $l {
            ...
            execute() {
                ...
                e.change(t => {
                    const o = n.isCollapsed ? [pg(n.getFirstPosition(), n.getAttribute("linkHref"), e)] : n.getRanges();
                    for (const e of o) if (t.removeAttribute("linkHref", e), i) for (const n of i.manualDecorators) t.removeAttribute(n.id, e)
                })
            }
        }

        var _g = function (t, e, n) {
            var i = -1, o = t.length;
            e < 0 && (e = -e > o ? 0 : o + e), (n = n > o ? o : n) < 0 && (n += o), o = e > n ? 0 : n - e >>> 0, e >>>= 0;
            for (var r = Array(o); ++i < o;) r[i] = t[i + e];
            return r
        };
        var vg = function (t, e, n) {
            var i = t.length;
            return n = void 0 === n ? i : n, !e && n >= i ? t : _g(t, e, n)
        }, yg = RegExp("[\\u200d\\ud800-\\udfff\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\ufe0e\\ufe0f]");
        var xg = function (t) {
            return yg.test(t)
        };
        var Ag = function (t) {
            ...
            Pg = "\\ud83c[\\udffb-\\udfff]", Mg = "[^\\ud800-\\udfff]", Sg = "(?:\\ud83c[\\udde6-\\uddff]){2}",
            Eg = "[\\ud800-\\udbff][\\udc00-\\udfff]", Ig = "(?:" + Tg + "|" + Pg + ")" + "?",
            Ng = "[\\ufe0e\\ufe0f]?" + Ig + ("(?:\\u200d(?:" + [Mg, Sg, Eg].join("|") + ")[\\ufe0e\\ufe0f]?" + Ig + ")*"),
            Og = "(?:" + [Mg + Tg + "?", Tg, Sg, Eg, Cg].join("|") + ")",
            Rg = RegExp(Pg + "(?=" + Pg + ")|" + Og + Ng, "g");
        var Dg = function (t) {
            return t.match(Rg) || []
        };
        var Lg = function (t) {
            return xg(t) ? Dg(t) : Ag(t)
        };
        var Vg = function (t, e) {
            for (var n = -1, i = null == t ? 0 : t.length, o = Array(i); ++n < i;) o[n] = e(t[n], n, t);
            return o
        }, jg = 1 / 0, zg = o ? o.prototype : void 0, Bg = zg ? zg.toString : void 0;
        var Fg = function t(e) {
            if ("string" == typeof e) return e;
            if (Wt(e)) return Vg(e, t) + "";
            if (os(e)) return Bg ? Bg.call(e) : "";
            var n = e + "";
            return "0" == n && 1 / e == -jg ? "-0" : n
        };
        var Ug = function (t) {
            return null == t ? "" : Fg(t)
        };
        var Hg = function (t) {
            return function (e) {
                e = Ug(e);
                var n = xg(e) ? Lg(e) : void 0, i = n ? n[0] : e.charAt(0), o = n ? vg(n, 1).join("") : e.slice(1);
                return i[t]() + o
            }
        }("toUpperCase");
        const qg = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,
            Wg = /^(?:(?:https?|ftps?|mailto):|[^a-z]|[a-z+.-]+(?:[^a-z+.:-]|$))/i;
        ...
        class Kg {
            constructor(t, e, n) {
                this.model = t, this.attribute = n, this._modelSelection = t.document.selection, this._overrideUid = null, this._isNextGravityRestorationSkipped = !1, e.listenTo(this._modelSelection, "change:range", (t, e) => {
                    this._isNextGravityRestorationSkipped ? this._isNextGravityRestorationSkipped = !1 : this._isGravityOverridden && (!e.directChange && Jg(this._modelSelection.getFirstPosition(), n) || this._restoreGravity())
                })
            }

            handleForwardMovement(t, e) {
                const n = this.attribute;
                if (!(this._isGravityOverridden || t.isAtStart && this._hasSelectionAttribute)) return tp(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._removeSelectionAttribute(), !0) : Zg(t, n) ? (this._preventCaretMovement(e), this._overrideGravity(), !0) : Xg(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._overrideGravity(), !0) : void 0
            }

            handleBackwardMovement(t, e) {
                const n = this.attribute;
                return this._isGravityOverridden ? tp(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._restoreGravity(), this._removeSelectionAttribute(), !0) : (this._preventCaretMovement(e), this._restoreGravity(), t.isAtStart && this._removeSelectionAttribute(), !0) : tp(t, n) && !this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._setSelectionAttributeFromTheNodeBefore(t), !0) : t.isAtEnd && Xg(t, n) ? this._hasSelectionAttribute ? void (ep(t, n) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity())) : (this._preventCaretMovement(e), this._setSelectionAttributeFromTheNodeBefore(t), !0) : t.isAtStart ? this._hasSelectionAttribute ? (this._removeSelectionAttribute(), this._preventCaretMovement(e), !0) : void 0 : void (ep(t, n) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity()))
            }
        ...
        function ep(t, e) {
            return Jg(t.getShiftedBy(-1), e)
        }

        n(123);
        const np = "ck-link_selected", ip = "automatic", op = "manual", rp = /^(https?:)?\/\//;
        ...
        class sp extends Ul {
            ...
            init() {
                ...
                }), t.commands.add("link", new wg(t)), t.commands.add("unlink", new kg(t));
                const e = function (t, e) {
                    const n = {"Open in a new tab": t("by"), Downloadable: t("bz")};
                    return e.forEach(t => (t.label && n[t.label] && (t.label = n[t.label]), t)), e
                }(t.t, function (t) {
                    const e = [];
                    if (t) for (const [n, i] of Object.entries(t)) {
                        const t = Object.assign({}, i, {id: `link${Hg(n)}`});
                        e.push(t)
                    }
                    return e
                }(t.config.get("link.decorators")));
                this._enableAutomaticDecorators(e.filter(t => t.mode === ip)), this._enableManualDecorators(e.filter(t => t.mode === op)), function (t, e, n, i) {
                    const o = new Kg(e, n, i), r = e.document.selection;
            ...
            _enableAutomaticDecorators(t) {
                const e = this.editor, n = new Gg;
                e.config.get("link.addTargetToExternalLinks") && n.add({
                    id: "linkIsExternal",
                    mode: ip,
                    callback: t => rp.test(t),
            ...
            _enableManualDecorators(t) {
                ...
                t.forEach(t => {
                    e.model.schema.extend("$text", {allowAttributes: t.id}), n.add(new Qg(t)), e.conversion.for("downcast").attributeToElement({
                        model: t.id,
                        view: (e, i) => {
                            if (e) {
            ...
            _setupLinkHighlight() {
                ...
                e.document.registerPostFixer(e => {
                    const i = t.model.document.selection;
                    if (i.hasAttribute("linkHref")) {
                        const o = pg(i.getFirstPosition(), i.getAttribute("linkHref"), t.model),
                            r = t.editing.mapper.toViewRange(o);
                        for (const t of r.getItems()) t.is("a") && (e.addClass(np, t), n.add(t))
                    }
                }), t.conversion.for("editingDowncast").add(t => {
                    function i() {
                        e.change(t => {
                            for (const e of n.values()) t.removeClass(np, e), n.delete(e)
                        })
                    }
        ...
        class cp extends Nl {
            constructor(t, e = []) {
                super(t);
                const n = t.t;
                this.focusTracker = new ol, this.keystrokes = new Kc, this.urlInputView = this._createUrlInput(), this.saveButtonView = this._createButton(n("ce"), qf.a, "ck-button-save"), this.saveButtonView.type = "submit", this.cancelButtonView = this._createButton(n("cf"), Yf.a, "ck-button-cancel", "cancel"), this._manualDecoratorSwitches = this._createManualDecoratorSwitches(e), this.children = this._createFormChildren(e), this._focusables = new hl, this._focusCycler = new Ll({
                    focusables: this._focusables,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
                    actions: {focusPrevious: "shift + tab", focusNext: "tab"}
            ...
            render() {
                super.render(), Uf({view: this}), [this.urlInputView, ...this._manualDecoratorSwitches, this.saveButtonView, this.cancelButtonView].forEach(t => {
                    this._focusables.add(t), this.focusTracker.add(t.element)
                }), this.keystrokes.listenTo(this.element)
            }
        ...
        var lp = n(46), dp = n.n(lp), up = n(47), hp = n.n(up);
        n(127);
        ...
        class fp extends Nl {
            constructor(t) {
                super(t);
                const e = t.t;
                this.focusTracker = new ol, this.keystrokes = new Kc, this.previewButtonView = this._createPreviewButton(), this.unlinkButtonView = this._createButton(e("ca"), dp.a, "unlink"), this.editButtonView = this._createButton(e("cb"), hp.a, "edit"), this.set("href"), this._focusables = new hl, this._focusCycler = new Ll({
                    focusables: this._focusables,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
                    actions: {focusPrevious: "shift + tab", focusNext: "tab"}
            ...
            _createPreviewButton() {
                ...
                return t.set({
                    ...
                    attributes: {
                        ...
                        href: e.to("href", t => t && $g(t)),
                        target: "_blank"
                    }
                }), t.bind("label").to(this, "href", t => t || n("cd")), t.bind("isEnabled").to(this, "href", t => !!t), t.template.tag = "a", t.template.eventListeners = {}, t
            }
        }

        var mp = n(48), gp = n.n(mp);
        const pp = "Ctrl+K";
        ...
        class bp extends Ul {
            ...
            init() {
                const t = this.editor;
                t.editing.view.addObserver(ap), this.actionsView = this._createActionsView(), this.formView = this._createFormView(), this._balloon = t.plugins.get(sm), this._createToolbarLinkButton(), this._enableUserBalloonInteractions()
            }
            ...
            _createActionsView() {
                const t = this.editor, e = new fp(t.locale), n = t.commands.get("link"), i = t.commands.get("unlink");
                return e.bind("href").to(n, "value"), e.editButtonView.bind("isEnabled").to(n), e.unlinkButtonView.bind("isEnabled").to(i), this.listenTo(e, "edit", () => {
                    ...
                    this._hideUI(), e()
                }), e.keystrokes.set(pp, (t, e) => {
                    this._addFormView(), e()
                }), e
            }

            _createFormView() {
                const t = this.editor, e = t.commands.get("link"), n = new cp(t.locale, e.manualDecorators);
            ...
            _createToolbarLinkButton() {
                ...
                t.keystrokes.set(pp, (t, n) => {
                    n(), e.isEnabled && this._showUI(!0)
                }), t.ui.componentFactory.add("link", t => {
                    const i = new Ld(t);
                    return i.isEnabled = !0, i.label = n("bh"), i.icon = gp.a, i.keystroke = pp, i.tooltip = !0, i.bind("isOn", "isEnabled").to(e, "value", "isEnabled"), this.listenTo(i, "execute", () => this._showUI(!0)), i
                })
            }
            ...
            _getSelectedLinkElement() {
                ...
                if (e.isCollapsed) return wp(e.getFirstPosition());
                {
                    const n = e.getFirstRange().getTrimmed(), i = wp(n.start), o = wp(n.end);
        ...
        class kp extends $l {
            ...
            execute() {
                const t = this.editor.model, e = t.document,
                    n = Array.from(e.selection.getSelectedBlocks()).filter(e => vp(e, t.schema)), i = !0 === this.value;
                t.change(t => {
                    if (i) {
        ...
        function Cp(t) {
            return (e, n, i) => {
                ...
                a && a.nextSibling && Vp(r, a, a.nextSibling), zp(i.mapper.toModelElement(o).getAttribute("listIndent") + 1, n.position, c.start, o, i, t);
        ...
        function Tp(t, e, n) {
            ...
            Vp(o, r = o.rename(s, r), r.nextSibling), Vp(o, r.previousSibling, r);
        ...
        function Pp(t) {
            return (e, n, i) => {
                ...
                r.remove(c), a && a.nextSibling && Vp(r, a, a.nextSibling), zp(n.attributeOldValue + 1, n.range.start, c.start, o, i, t), jp(n.item, o, i, t);
                ...
                if (o.length > 0) {
                    for (let e = 0; e < o.length; e++) {
                        ...
                        if (t = i.insert(t, o[e]).end, e > 0) {
                            const e = Vp(i, n, n.nextSibling);
                            e && e.parent == n && t.offset--
                        }
                    }
                    Vp(i, t.nodeBefore, t.nodeAfter)
                }
            }
        }
            ...
            if (n.consumable.consume(e.viewItem, {name: !0})) {
                ...
                const a = function (t, e, n) {
                    ...
                    for (const s of e) if ("ul" == s.name || "ol" == s.name) r = n.convertItem(s, r).modelCursor; else {
                        ...
                        c && (t = e.modelCursor.parent.is("listItem") ? e.modelCursor.parent : Dp(e.modelCursor), r = i.createPositionAfter(t))
                    }
                    return r
        ...
        function jp(t, e, n, i) {
            ...
            if (a = Bp(a), s.insert(a, o), l && "listItem" == l.name) {
                ...
                for (const t of n) if (t.item.is("li")) {
                    ...
                    Vp(s, r.nodeBefore, r.nodeAfter), s.move(s.createRangeOn(o), r), n.position = i
                }
            } else {
            ...
            Vp(s, o, o.nextSibling), Vp(s, o.previousSibling, o)
        }

        function zp(t, e, n, i, o, r) {
            const s = Lp(e.nodeBefore, {sameIndent: !0, smallerIndent: !0, listIndent: t, foo: "b"}), a = o.mapper,
            ...
            d = Bp(d);
            for (const t of [...i.getChildren()]) (t.is("ul") || t.is("ol")) && (d = c.move(c.createRangeOn(t), d).end, Vp(c, t, t.nextSibling), Vp(c, t.previousSibling, t))
        }
        ...
        class Fp extends Ul {
            ...
            init() {
                ...
                })(t.model, e)), n.mapper.registerViewToModelLength("li", Up), e.mapper.registerViewToModelLength("li", Up), n.mapper.on("modelToViewPosition", Op(n.view)), n.mapper.on("viewToModelPosition", function (t) {
                    return (e, n) => {
                ...
                }(t.model)), e.mapper.on("modelToViewPosition", Op(n.view)), n.downcastDispatcher.on("insert", Mp, {priority: "high"}), n.downcastDispatcher.on("insert:listItem", Ap(t.model)), e.downcastDispatcher.on("insert", Mp, {priority: "high"}), e.downcastDispatcher.on("insert:listItem", Ap(t.model)), n.downcastDispatcher.on("attribute:listType:listItem", Tp), e.downcastDispatcher.on("attribute:listType:listItem", Tp), n.downcastDispatcher.on("attribute:listIndent:listItem", Pp(t.model)), e.downcastDispatcher.on("attribute:listIndent:listItem", Pp(t.model)), n.downcastDispatcher.on("remove:listItem", Cp(t.model)), n.downcastDispatcher.on("remove", Sp, {priority: "low"}), e.downcastDispatcher.on("remove:listItem", Cp(t.model)), e.downcastDispatcher.on("remove", Sp, {priority: "low"}), e.upcastDispatcher.on("element:ul", Ip, {priority: "high"}), e.upcastDispatcher.on("element:ol", Ip, {priority: "high"}), e.upcastDispatcher.on("element:li", Np, {priority: "high"}), e.upcastDispatcher.on("element:li", Ep), t.model.on("insertContent", Rp, {priority: "high"}), t.commands.add("numberedList", new kp(t, "numbered")), t.commands.add("bulletedList", new kp(t, "bulleted")), t.commands.add("indentList", new yp(t, "forward")), t.commands.add("outdentList", new yp(t, "backward"));
        ...
        function Up(t) {
            let e = 1;
            for (const n of t.getChildren()) if ("ul" == n.name || "ol" == n.name) for (const t of n.getChildren()) e += Up(t);
            return e
        }

        var Hp = n(49), qp = n.n(Hp), Wp = n(50), Yp = n.n(Wp);

        class $p extends Ul {
            init() {
                const t = this.editor.t;
                this._addButton("numberedList", t("ak"), qp.a), this._addButton("bulletedList", t("al"), Yp.a)
            }

            _addButton(t, e, n) {
                const i = this.editor;
                i.ui.componentFactory.add(t, o => {
                    const r = i.commands.get(t), s = new Ld(o);
                    return s.set({
                        label: e,
                        icon: n,
                        tooltip: !0
        ...
        function Qp(t, e, n, i) {
            ...
            return o.getFillerOffset = Zp, t.insert(t.createPositionAt(o, 0), e.getMediaViewElement(t, n, i)), o
        }
        ...
        class Xp extends $l {
            ...
            execute(t) {
                const e = this.editor.model, n = e.document.selection, i = Kp(n);
                if (i) e.change(e => {
        ...
        class ib {
            ...
            _getMedia(t) {
                if (!t) return new ob(this.locale);
                t = t.trim();
                for (const e of this.providerDefinitions) {
                    ...
                    for (const e of i) {
                        ...
                        if (i) return new ob(this.locale, t, i, n)
                    }
                }
                return null
            }
        ...
        class ob {
            ...
            _getPlaceholderHtml() {
                ...
                return t.text = this._t("Open media in new tab"), e.content = eb.a, e.viewBox = nb, new ml({
                    tag: "div",
        ...
        class rb extends Ul {
            ...
            constructor(t) {
                ...
                }), this.registry = new ib(t.locale, t.config.get("mediaEmbed"))
            }

            init() {
                const t = this.editor, e = t.model.schema, n = t.t, i = t.conversion,
                    o = t.config.get("mediaEmbed.previewsInData"), r = this.registry;
                t.commands.add("mediaEmbed", new Xp(t)), e.register("media", {
                    isObject: !0,
                    isBlock: !0,
                    allowWhere: "$block",
                    allowAttributes: ["url"]
                    ...
                    model: "media", view: (t, e) => {
                        ...
                        return Qp(e, r, n, {renderMediaPreview: n && o})
                    }
                }), i.for("dataDowncast").add(Gp(r, {renderMediaPreview: o})), i.for("editingDowncast").elementToElement({
                    model: "media",
                    view: (t, e) => {
                        const i = t.getAttribute("url");
                        return function (t, e, n) {
                            return e.setCustomProperty("media", !0, t), yf(t, e, {label: n})
                        }(Qp(e, r, i, {renderForEditingView: !0}), e, n("bg"))
                    }
                }), i.for("editingDowncast").add(Gp(r, {renderForEditingView: !0})), i.for("upcast").elementToElement({
                    view: {
                        name: "oembed",
                        attributes: {url: !0}
                    }, model: (t, e) => {
        ...
        class ab extends Ul {
            ...
            init() {
                ...
                this.listenTo(t.plugins.get(Yl), "inputTransformation", () => {
                    const t = e.selection.getFirstRange(), n = Rc.fromPosition(t.start);
            ...
            _embedMediaBetweenPositions(t, e) {
                const n = this.editor, i = n.plugins.get(rb).registry, o = new ra(t, e),
                    r = o.getWalker({ignoreElementEnd: !0});
                let s = "";
                for (const t of r) t.item.is("textProxy") && (s += t.item.data);
                if (!(s = s.trim()).match(sb)) return;
                if (!i.hasMedia(s)) return;
                n.commands.get("mediaEmbed").isEnabled && (this._positionToInsert = Rc.fromPosition(t), this._timeoutId = nr.window.setTimeout(() => {
                    n.model.change(t => {
                        let e;
                        this._timeoutId = null, t.remove(o), "$graveyard" !== this._positionToInsert.root.rootName && (e = this._positionToInsert), Jp(n.model, s, e), this._positionToInsert.detach(), this._positionToInsert = null
                    })
                }, 100))
            }
        }
        ...
        class cb extends Nl {
            ...
            render() {
                super.render(), Uf({view: this}), [this.urlInputView, this.saveButtonView, this.cancelButtonView].forEach(t => {
                    this._focusables.add(t), this.focusTracker.add(t.element)
                }), this.keystrokes.listenTo(this.element);
            ...
            _createUrlInput() {
                const t = this.locale.t, e = new Bf(this.locale, Ff), n = e.inputView;
                return this._urlInputViewInfoDefault = t("dd"), this._urlInputViewInfoTip = t("de"), e.label = t("df"), e.infoText = this._urlInputViewInfoDefault, n.placeholder = "https://example.com", n.on("input", () => {
        ...
        class ub extends Ul {
            ...
            init() {
                const t = this.editor, e = t.commands.get("mediaEmbed"), n = t.plugins.get(rb).registry;
                this.form = new cb(function (t, e) {
                    return [e => {
        ...
        function fb(t) {
            ...
            const o = i.body.innerHTML, r = function (t) {
                const e = new rr({blockFiller: Vo}), n = t.createDocumentFragment(), i = t.body.childNodes;
                for (; i.length > 0;) n.appendChild(i[0]);
        ...
        function pb(t, e) {
            ...
            i.length && function (t, e, n) {
                if (t.length === e.length) for (let i = 0; i < t.length; i++) {
                    const o = `data:${e[i].type};base64,${bb(e[i].hex)}`;
                ...
                t.on("element:table", (t, e, n) => {
                    ...
                    if (l) {
                        if (n.writer.insert(c, l.position), n.consumable.consume(i, {name: !0}), o.length) o.forEach(t => n.convertItem(t, n.writer.createPositionAt(c, "end"))); else {
                            ...
                            n.writer.insert(t, n.writer.createPositionAt(c, "end")), _b(n.writer, n.writer.createPositionAt(t, "end"))
                        }
        ...
        function Cb(t) {
            return !!t.getCustomProperty("table") && vf(t)
        }

        function Tb(t) {
            const e = t.getSelectedElement();
            return e && Cb(e) ? e : null
        }

        function Pb(t) {
            const e = wb("table", t.getFirstPosition());
            return e && Cb(e.parent) ? e.parent : null
        }
        ...
        function Mb(t = {}) {
            return e => e.on("insert:table", (e, n, i) => {
                ...
                i.writer.insert(i.writer.createPositionAt(s, 0), a), r && (c = function (t, e) {
                    return e.setCustomProperty("table", !0, t), yf(t, e, {hasSelectionHandler: !0})
                }(s, i.writer));
                const l = new Ab(o), d = {
                ...
                for (const e of l) {
                    const {row: n, cell: r} = e, s = zb(jb(n, d), a, i), c = o.getChild(n),
                        l = u.get(n) || Lb(c, n, s, i);
                    u.set(n, l), i.consumable.consume(r, "insert"), Db(e, d, i.writer.createPositionAt(l, "end"), i, t)
                }
        ...
        function Sb(t = {}) {
            return e => e.on("insert:tableRow", (e, n, i) => {
                const o = n.item;
                if (!i.consumable.consume(o, "insert")) return;
                const r = o.parent, s = Hb(i.mapper.toViewElement(r)), a = r.getChildIndex(o),
                    c = new Ab(r, {startRow: a, endRow: a}), l = {
                        headingRows: r.getAttribute("headingRows") || 0,
                        headingColumns: r.getAttribute("headingColumns") || 0
                    }, d = new Map;
                for (const e of c) {
                    const n = zb(jb(a, l), s, i), r = d.get(a) || Lb(o, a, n, i);
                    d.set(a, r), i.consumable.consume(e.cell, "insert"), Db(e, l, i.writer.createPositionAt(r, "end"), i, t)
                }
            })
        }
        ...
        function Eb(t = {}) {
            return e => e.on("insert:tableCell", (e, n, i) => {
                const o = n.item;
                if (!i.consumable.consume(o, "insert")) return;
                const r = o.parent, s = r.parent, a = s.getChildIndex(r), c = new Ab(s, {startRow: a, endRow: a}), l = {
                ...
                for (const e of c) if (e.cell === o) {
                    ...
                    return void Db(e, l, i.writer.createPositionAt(n, r.getChildIndex(o)), i, t)
                }
            })
        }
        ...
        function Ib(t = {}) {
            ...
            return t => t.on("attribute:headingRows:table", (t, n, i) => {
                ...
                const r = Hb(i.mapper.toViewElement(o)), s = n.attributeOldValue, a = n.attributeNewValue;
                if (a > s) {
                    const t = Array.from(o.getChildren()).filter(({index: t}) => c(t, s - 1, a));
                    Ub(t, zb("thead", r, i), i, "end");
                    for (const n of t) for (const t of n.getChildren()) Ob(t, "th", i, e);
                    Fb("tbody", r, i)
                } else {
                    Ub(Array.from(o.getChildren()).filter(({index: t}) => c(t, a - 1, s)).reverse(), zb("tbody", r, i), i, 0);
                    const t = new Ab(o, {startRow: a ? a - 1 : a, endRow: s - 1}), n = {
                        headingRows: o.getAttribute("headingRows") || 0,
                        headingColumns: o.getAttribute("headingColumns") || 0
                    };
                    for (const o of t) Rb(o, n, i, e);
                    Fb("thead", r, i)
                }
        ...
        function Nb(t = {}) {
            ...
            return t => t.on("attribute:headingColumns:table", (t, n, i) => {
                ...
                for (const t of new Ab(o)) t.column > c || Rb(t, r, i, e)
            })
        }
        ...
        function Rb(t, e, n, i) {
            const {cell: o} = t, r = Vb(t, e), s = n.mapper.toViewElement(o);
            s && s.name !== r && Ob(o, r, n, i)
        }

        function Db(t, e, n, i, o) {
            const r = o && o.asWidget, s = Vb(t, e),
                a = r ? Af(i.writer.createEditableElement(s), i.writer) : i.writer.createContainerElement(s),
        ...
        class qb extends $l {
            ...
            execute(t = {}) {
                const e = this.editor.model, n = e.document.selection, i = this.editor.plugins.get("TableUtils"),
                    o = parseInt(t.rows) || 2, r = parseInt(t.columns) || 2, s = Cf(n, e);
                e.change(t => {
        ...
        class Wb extends $l {
            ...
            refresh() {
                const t = wb("table", this.editor.model.document.selection.getFirstPosition());
                this.isEnabled = !!t
            }

            execute() {
                const t = this.editor, e = t.model.document.selection, n = t.plugins.get("TableUtils"),
                    i = wb("tableCell", e.getFirstPosition()).parent, o = i.parent, r = o.getChildIndex(i),
        ...
        class Yb extends $l {
            ...
            execute() {
                const t = this.editor, e = t.model.document.selection, n = t.plugins.get("TableUtils"),
                    i = wb("tableCell", e.getFirstPosition()), o = i.parent.parent, {column: r} = n.getCellLocation(i),
        ...
        class $b extends $l {
            ...
            refresh() {
                const t = wb("tableCell", this.editor.model.document.selection.getFirstPosition());
                this.isEnabled = !!t
            }
        ...
        class Gb extends $l {
            ...
            execute() {
                const t = this.editor.model, e = wb("tableCell", t.document.selection.getFirstPosition()),
                ...
                t.change(t => {
                    ...
                    t.setAttribute(c, l + d, r), t.setSelection(t.createRangeIn(r)), a.childCount || function (t, e) {
                        ...
                        for (const {cell: t, row: o, rowspan: r} of new Ab(n, {endRow: i})) {
                            const n = o + r - 1 >= i;
                            n && kb("rowspan", r - 1, t, e)
                        }
                        e.remove(t)
                    }(a, t)
                })
            ...
            _getMergeableCell() {
                ...
                const e = this.editor.plugins.get("TableUtils"), n = this.isHorizontal ? function (t, e, n) {
                    ...
                    const a = parseInt(t.getAttribute("rowspan") || 1), c = "down" == e ? o + a : o,
                        l = [...new Ab(i, {endRow: c})], d = l.find(e => e.cell === t).column,
        ...
        class Kb extends $l {
            ...
            execute() {
                const t = this.editor.model, e = wb("tableCell", t.document.selection.getFirstPosition()).parent,
                    n = e.parent, i = n.getChildIndex(e), o = n.getAttribute("headingRows") || 0;
                t.change(t => {
                    o && i <= o && kb("headingRows", o - 1, n, t, 0);
                    const r = [...new Ab(n, {endRow: i})], s = new Map;
                    r.filter(({row: t, rowspan: e}) => t === i && e > 1).forEach(({column: t, cell: e, rowspan: n}) => s.set(t, {
                        cell: e,
                        rowspanToSet: n - 1
                    })), r.filter(({row: t, rowspan: e}) => t <= i - 1 && t + e > i).forEach(({cell: e, rowspan: n}) => kb("rowspan", n - 1, e, t));
                    const a = i + 1, c = new Ab(n, {includeSpanned: !0, startRow: a, endRow: a});
                    let l;
                    for (const {row: e, column: i, cell: o} of [...c]) if (s.has(i)) {
                        ...
                        t.move(t.createRangeOn(o), a), kb("rowspan", r, o, t), l = o
                    } else l = o;
                    t.remove(e)
                })
            }
        ...
        class Jb extends $l {
            refresh() {
                const t = this.editor, e = t.model.document.selection, n = t.plugins.get("TableUtils"),
                    i = wb("tableCell", e.getFirstPosition());
                this.isEnabled = !!i && n.getColumns(i.parent.parent) > 1
            }

            execute() {
                const t = this.editor.model, e = wb("tableCell", t.document.selection.getFirstPosition()), n = e.parent,
                    i = n.parent, o = i.getAttribute("headingColumns") || 0, r = i.getChildIndex(n), s = [...new Ab(i)],
                    a = s.find(t => t.cell === e).column;
                t.change(t => {
                    o && r <= o && t.setAttribute("headingColumns", o - 1, i);
                    for (const {cell: e, column: n, colspan: i} of s) n <= a && i > 1 && n + i > a ? kb("colspan", i - 1, e, t) : n === a && t.remove(e)
                })
            }
        }
        ...
        class Zb extends $l {
            refresh() {
                const t = wb("tableCell", this.editor.model.document.selection.getFirstPosition()), e = !!t;
                ...
                t.change(t => {
                    if (r) {
                        const e = function (t, e, n) {
                            const i = [], o = new Ab(t, {startRow: e > n ? n : 0, endRow: e - 1});
                            for (const {row: t, rowspan: n, cell: r} of o) n > 1 && t + n > e && i.push(r);
                            return i
                        }(n, r, i);
                        for (const n of e) Xb(n, r, t)
                    }
                    kb("headingRows", r, n, t, 0)
                })
            }
        ...
        function Xb(t, e, n) {
            ...
            a > 1 && (s.rowspan = a);
            const c = o.getChildIndex(i), l = c + r, d = [...new Ab(o, {startRow: c, endRow: l, includeSpanned: !0})];
            let u;
        ...
        class tw extends $l {
            ...
            execute() {
                const t = this.editor.model, e = t.document.selection, n = this.editor.plugins.get("TableUtils"),
                    i = wb("tableCell", e.getFirstPosition().parent), o = i.parent.parent,
                    r = parseInt(o.getAttribute("headingColumns") || 0), {column: s} = n.getCellLocation(i),
                    a = r > s ? s : s + 1;
                t.change(t => {
                    kb("headingColumns", a, o, t, 0)
                })
            }
        ...
        class ew extends Ul {
            ...
            getCellLocation(t) {
                const e = t.parent, n = e.parent, i = n.getChildIndex(e), o = new Ab(n, {startRow: i, endRow: i});
                for (const {cell: e, row: n, column: i} of o) if (e === t) return {row: n, column: i}
            }

            createTable(t, e, n) {
                const i = t.createElement("table");
                return nw(t, i, 0, e, n), i
            }
            ...
            insertRows(t, e = {}) {
                ...
                n.change(e => {
                    ...
                    if (n > i && e.setAttribute("headingRows", n + o, t), 0 === i || i === t.childCount) return void nw(e, t, i, o, this.getColumns(t));
                    const r = new Ab(t, {endRow: i});
                    let s = 0;
            ...
            insertColumns(t, e = {}) {
                ...
                n.change(e => {
                    ...
                    if (0 === i || r === i) {
                        for (const n of t.getChildren()) iw(o, e, e.createPositionAt(n, i ? "end" : 0));
                        return
                    }
                    const s = new Ab(t, {column: i, includeSpanned: !0});
            ...
            splitCellVertically(t, e = 2) {
                ...
                n.change(n => {
                    if (r > 1) {
                        const {newCellsSpan: i, updatedSpan: s} = ow(r, e);
                        kb("colspan", s, t, n);
                        const a = {};
                        i > 1 && (a.colspan = i), o > 1 && (a.rowspan = o), iw(r > e ? e - 1 : r - 1, n, n.createPositionAfter(t), a)
                    }
                    if (r < e) {
                        const s = e - r, a = [...new Ab(i)], {column: c} = a.find(({cell: e}) => e === t),
                            l = a.filter(({cell: e, colspan: n, column: i}) => {
                                return e !== t && i === c || i < c && i + n > c
                            });
                        for (const {cell: t, colspan: e} of l) n.setAttribute("colspan", e + s, t);
                        const d = {};
                        o > 1 && (d.rowspan = o), iw(s, n, n.createPositionAfter(t), d);
                        const u = i.getAttribute("headingColumns") || 0;
                        u > c && kb("headingColumns", u + s, i, n)
                    }
                })
            }
                ...
                n.change(n => {
                    if (s > 1) {
                        const i = [...new Ab(o, {
                            ...
                            endRow: r + s - 1,
                            includeSpanned: !0
                        })], {newCellsSpan: c, updatedSpan: l} = ow(s, e);
                        kb("rowspan", l, t, n);
                        ...
                        for (const {column: t, row: e, cellIndex: s} of i) {
                            if (e >= r + l && t === d && (e + r + l) % c == 0) {
                                iw(1, n, n.createPositionAt(o.getChild(e), s), u)
                            }
                        }
                    }
                    if (s < e) {
                        const i = e - s, c = [...new Ab(o, {startRow: 0, endRow: r})];
                        for (const {cell: e, rowspan: o, row: s} of c) if (e !== t && s + o > r) {
                            const t = o + i;
                            n.setAttribute("rowspan", t, e)
                        }
                        const l = {};
                        a > 1 && (l.colspan = a), nw(n, o, r + 1, i, 1, l);
                        const d = o.getAttribute("headingRows") || 0;
                        d > r && kb("headingRows", d + i, o, n)
                    }
                })
            }
        ...
        function nw(t, e, n, i, o, r = {}) {
            for (let s = 0; s < i; s++) {
                ...
                t.insert(i, e, n), iw(o, t, t.createPositionAt(i, "end"), r)
            }
        }

        function iw(t, e, n, i = {}) {
            for (let o = 0; o < t; o++) _b(e, n, i)
        }
        ...
        function rw(t) {
            t.document.registerPostFixer(e => (function (t, e) {
                ...
                for (const e of n) {
                    let n;
                    "table" == e.name && "insert" == e.type && (n = e.position.nodeAfter), "tableRow" != e.name && "tableCell" != e.name || (n = wb("table", e.position)), cw(e) && (n = wb("table", e.range.start)), n && !o.has(n) && (i = sw(n, t) || i, i = aw(n, t) || i, o.add(n))
                }
                return i
            })(e, t))
        }
        ...
        function sw(t, e) {
            ...
            const i = function (t) {
                ...
                for (const {row: o, rowspan: r, cell: s} of new Ab(t)) {
                    if (r < 2) continue;
                    const t = o < e, a = t ? e : n;
                    if (o + r > a) {
                        const t = a - o;
            ...
            if (i.length) {
                n = !0;
                for (const t of i) kb("rowspan", t.rowspan, t.cell, e, 1)
            }
            return n
        }
        ...
        function aw(t, e) {
            ...
            const i = function (t) {
                const e = {};
                for (const {row: n} of new Ab(t, {includeSpanned: !0})) e[n] || (e[n] = 0), e[n] += 1;
                return e
            }(t), o = i[0];
            if (!Object.values(i).every(t => t === o)) {
                ...
                for (const [r, s] of Object.entries(i)) {
                    const i = o - s;
                    if (i) {
                        for (let n = 0; n < i; n++) _b(e, e.createPositionAt(t.getChild(r), "end"));
                        n = !0
                    }
                }
            }
        ...
        function lw(t) {
            t.document.registerPostFixer(e => (function (t, e) {
                const n = e.document.differ.getChanges();
                let i = !1;
                for (const e of n) "remove" == e.type && e.position.parent.is("tableCell") && (i = hw(e.position.parent, t) || i), "insert" == e.type && ("table" == e.name && (i = dw(e.position.nodeAfter, t) || i), "tableRow" == e.name && (i = uw(e.position.nodeAfter, t) || i), "tableCell" == e.name && (i = hw(e.position.nodeAfter, t) || i));
                return i
            })(e, t))
        }
        ...
        function dw(t, e) {
            let n = !1;
            for (const i of t.getChildren()) n = uw(i, e) || n;
            return n
        }

        function uw(t, e) {
            let n = !1;
            for (const i of t.getChildren()) n = hw(i, e) || n;
            return n
        }
        ...
        function fw(t, e) {
            e.view.document.registerPostFixer(n => (function (t, e, n, i) {
                let o = !1;
                const r = function (t) {
                    const e = Array.from(t._renderer.markedAttributes).filter(t => !!t.parent).filter(gw).filter(t => pw(t.parent)),
                        n = Array.from(t._renderer.markedChildren).filter(t => !!t.parent).filter(pw).reduce((t, e) => {
                            const n = Array.from(e.getChildren()).filter(gw);
                            return [...t, ...n]
                        }, []);
                    return [...e, ...n]
                }(i);
                for (const e of r) o = mw(e, n, t) || o;
                o && function (t) {
        ...
        class bw extends Ul {
            init() {
                ...
                }), i.for("upcast").add(vb()), i.for("editingDowncast").add(Mb({asWidget: !0})), i.for("dataDowncast").add(Mb()), i.for("upcast").elementToElement({
                    model: "tableRow",
                    view: "tr"
                }), i.for("editingDowncast").add(Sb({asWidget: !0})), i.for("dataDowncast").add(Sb()), i.for("downcast").add(t => t.on("remove:tableRow", (t, e, n) => {
                    t.stop();
                ...
                }, {priority: "higher"})), i.for("upcast").add(yb("td")), i.for("upcast").add(yb("th")), i.for("editingDowncast").add(Eb({asWidget: !0})), i.for("dataDowncast").add(Eb()), i.attributeToAttribute({
                    model: "colspan",
                    view: "colspan"
                }), i.attributeToAttribute({
                    model: "rowspan",
                    view: "rowspan"
                }), i.for("editingDowncast").add(Nb({asWidget: !0})), i.for("dataDowncast").add(Nb()), i.for("editingDowncast").add(Ib({asWidget: !0})), i.for("dataDowncast").add(Ib()), fw(t.model, t.editing), t.commands.add("insertTable", new qb(t)), t.commands.add("insertTableRowAbove", new Wb(t, {order: "above"})), t.commands.add("insertTableRowBelow", new Wb(t, {order: "below"})), t.commands.add("insertTableColumnLeft", new Yb(t, {order: "left"})), t.commands.add("insertTableColumnRight", new Yb(t, {order: "right"})), t.commands.add("removeTableRow", new Kb(t)), t.commands.add("removeTableColumn", new Jb(t)), t.commands.add("splitTableCellVertically", new $b(t, {direction: "vertically"})), t.commands.add("splitTableCellHorizontally", new $b(t, {direction: "horizontally"})), t.commands.add("mergeTableCellRight", new Gb(t, {direction: "right"})), t.commands.add("mergeTableCellLeft", new Gb(t, {direction: "left"})), t.commands.add("mergeTableCellDown", new Gb(t, {direction: "down"})), t.commands.add("mergeTableCellUp", new Gb(t, {direction: "up"})), t.commands.add("setTableColumnHeader", new tw(t)), t.commands.add("setTableRowHeader", new Zb(t)), rw(e), lw(e), this.editor.keystrokes.set("Tab", (...t) => this._handleTabOnSelectedTable(...t), {priority: "low"}), this.editor.keystrokes.set("Tab", this._getTabHandler(!0), {priority: "low"}), this.editor.keystrokes.set("Shift+Tab", this._getTabHandler(!1), {priority: "low"})
            }
            ...
            _getTabHandler(t) {
                const e = this.editor;
                return (n, i) => {
                    const o = wb("tableCell", e.model.document.selection.getFirstPosition());
                    if (!o) return;
                    i();
        ...
        var _w = n(53), vw = n.n(_w), yw = n(54), xw = n.n(yw), Aw = n(55), Cw = n.n(Aw), Tw = n(56), Pw = n.n(Tw);

        class Mw extends Ul {
            init() {
                const t = this.editor, e = this.editor.t;
                t.ui.componentFactory.add("insertTable", n => {
                    const i = t.commands.get("insertTable"), o = lu(n);
                    o.bind("isEnabled").to(i), o.buttonView.set({icon: vw.a, label: e("ao"), tooltip: !0});
                    const r = new ww(n);
                    ...
                    const n = [{
                        type: "switchbutton",
                        model: {commandName: "setTableColumnHeader", label: e("ap"), bindIsOn: !0}
                    }, {type: "separator"}, {
                        type: "button",
                        model: {commandName: "insertTableColumnLeft", label: e("aq")}
                    }, {
                        type: "button",
                        model: {commandName: "insertTableColumnRight", label: e("ar")}
                    }, {type: "button", model: {commandName: "removeTableColumn", label: e("as")}}];
                    return this._prepareDropdown(e("at"), xw.a, n, t)
                }), t.ui.componentFactory.add("tableRow", t => {
                    const n = [{
                        type: "switchbutton",
                        model: {commandName: "setTableRowHeader", label: e("au"), bindIsOn: !0}
                    }, {type: "separator"}, {
                        type: "button",
                        model: {commandName: "insertTableRowBelow", label: e("av")}
                    }, {type: "button", model: {commandName: "insertTableRowAbove", label: e("aw")}}, {
                        type: "button",
                        model: {commandName: "removeTableRow", label: e("ax")}
                    }];
                    return this._prepareDropdown(e("ay"), Cw.a, n, t)
                }), t.ui.componentFactory.add("mergeTableCells", t => {
                    const n = [{
                        type: "button",
                        model: {commandName: "mergeTableCellUp", label: e("az")}
                    }, {type: "button", model: {commandName: "mergeTableCellRight", label: e("ba")}}, {
                        type: "button",
                        model: {commandName: "mergeTableCellDown", label: e("bb")}
                    }, {
                        type: "button",
                        model: {commandName: "mergeTableCellLeft", label: e("bc")}
                    }, {type: "separator"}, {
                        type: "button",
                        model: {commandName: "splitTableCellVertically", label: e("bd")}
                    }, {type: "button", model: {commandName: "splitTableCellHorizontally", label: e("be")}}];
                    return this._prepareDropdown(e("bf"), Pw.a, n, t)
                })
            }

            _prepareDropdown(t, e, n, i) {
                const o = this.editor, r = lu(i), s = [], a = new oo;
                for (const t of n) Sw(t, o, s, a);
        ...
        function Sw(t, e, n, i) {
            const o = t.model = new Du(t.model), {commandName: r, bindIsOn: s} = t.model;
            if ("separator" !== t.type) {
        ...
        Ew.builtinPlugins = [class extends Ul {
            static get requires() {
            ...
            _addBasicStylesAutoformats() {
                const t = this.editor.commands;
                if (t.get("bold")) {
                    const t = gh(this.editor, "bold");
                    new fh(this.editor, /(\*\*)([^*]+)(\*\*)$/g, t), new fh(this.editor, /(__)([^_]+)(__)$/g, t)
                }
                if (t.get("italic")) {
                    const t = gh(this.editor, "italic");
                    new fh(this.editor, /(?:^|[^*])(\*)([^*_]+)(\*)$/g, t), new fh(this.editor, /(?:^|[^_])(_)([^_]+)(_)$/g, t)
                }
                if (t.get("code")) {
                    const t = gh(this.editor, "code");
                    new fh(this.editor, /(`)([^`]+)(`)$/g, t)
                }
            }
            ...
            afterInit() {
                const t = this.editor;
                t.plugins.get(mg).register("image", {items: t.config.get("image.toolbar") || [], getRelatedElement: Pf})
            }
        }, Rm, class extends Ul {
            static get requires() {
                return [sp, bp]
            ...
            _normalizeWordInput(t, e) {
                const {body: n, stylesString: i} = fb(t);
                return mb(n, i), pb(n, e.getData("text/rtf")), n
            }
        }, class extends Ul {
            static get requires() {
                return [bw, Mw, Lf]
            ...
            afterInit() {
                const t = this.editor, e = t.plugins.get(mg), n = t.config.get("table.contentToolbar"),
                    i = t.config.get("table.tableToolbar");
                n && e.register("tableContent", {items: n, getRelatedElement: Pb}), i && e.register("table", {
                    items: i,
                    getRelatedElement: Tb
                })
            }
        }], Ew.defaultConfig = {
            toolbar: {items: ["heading", "|", "fontsize", "fontfamily", "|", "bold", "italic", "underline", "strikethrough", "highlight", "|", "alignment", "|", "numberedList", "bulletedList", "|", "link", "blockquote", "imageUpload", "insertTable", "mediaEmbed", "|", "undo", "redo"]},
            image: {
